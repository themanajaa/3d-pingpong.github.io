...
`)+`
`+f);const b=T+m+o,y=T+f+a,I=Mu(r,r.VERTEX_SHADER,b),w=Mu(r,r.FRAGMENT_SHADER,y);r.attachShader(v,I),r.attachShader(v,w),e.index0AttributeName!==void 0?r.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function R(A){if(n.debug.checkShaderErrors){const N=r.getProgramInfoLog(v).trim(),O=r.getShaderInfoLog(I).trim(),W=r.getShaderInfoLog(w).trim();let X=!0,G=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(X=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,I,w);else{const q=Tu(r,I,"vertex"),H=Tu(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
Program Info Log: `+N+`
`+q+`
`+H)}else N!==""?console.warn("THREE.WebGLProgram: Program Info Log:",N):(O===""||W==="")&&(G=!1);G&&(A.diagnostics={runnable:X,programLog:N,vertexShader:{log:O,prefix:m},fragmentShader:{log:W,prefix:f}})}r.deleteShader(I),r.deleteShader(w),U=new ro(r,v),E=I0(r,v)}let U;this.getUniforms=function(){return U===void 0&&R(this),U};let E;this.getAttributes=function(){return E===void 0&&R(this),E};let x=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return x===!1&&(x=r.getProgramParameter(v,y0)),x},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=M0++,this.cacheKey=t,this.usedTimes=1,this.program=v,this.vertexShader=I,this.fragmentShader=w,this}let G0=0;class W0{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,i=t.fragmentShader,r=this._getShaderStage(e),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(t);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const i of e)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let i=e.get(t);return i===void 0&&(i=new Set,e.set(t,i)),i}_getShaderStage(t){const e=this.shaderCache;let i=e.get(t);return i===void 0&&(i=new X0(t),e.set(t,i)),i}}class X0{constructor(t){this.id=G0++,this.code=t,this.usedTimes=0}}function $0(n,t,e,i,r,s,o){const a=new th,c=new W0,l=new Set,u=[],d=r.logarithmicDepthBuffer,h=r.vertexTextures;let p=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(E){return l.add(E),E===0?"uv":`uv${E}`}function m(E,x,A,N,O){const W=N.fog,X=O.geometry,G=E.isMeshStandardMaterial?N.environment:null,q=(E.isMeshStandardMaterial?e:t).get(E.envMap||G),H=q&&q.mapping===To?q.image.height:null,et=g[E.type];E.precision!==null&&(p=r.getMaxPrecision(E.precision),p!==E.precision&&console.warn("THREE.WebGLProgram.getParameters:",E.precision,"not supported, using",p,"instead."));const dt=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,St=dt!==void 0?dt.length:0;let Ot=0;X.morphAttributes.position!==void 0&&(Ot=1),X.morphAttributes.normal!==void 0&&(Ot=2),X.morphAttributes.color!==void 0&&(Ot=3);let ie,Y,tt,gt;if(et){const Jt=xn[et];ie=Jt.vertexShader,Y=Jt.fragmentShader}else ie=E.vertexShader,Y=E.fragmentShader,c.update(E),tt=c.getVertexShaderID(E),gt=c.getFragmentShaderID(E);const st=n.getRenderTarget(),bt=n.state.buffers.depth.getReversed(),jt=O.isInstancedMesh===!0,At=O.isBatchedMesh===!0,fe=!!E.map,ce=!!E.matcap,kt=!!q,C=!!E.aoMap,je=!!E.lightMap,Vt=!!E.bumpMap,zt=!!E.normalMap,xt=!!E.displacementMap,se=!!E.emissiveMap,vt=!!E.metalnessMap,M=!!E.roughnessMap,_=E.anisotropy>0,B=E.clearcoat>0,j=E.dispersion>0,Z=E.iridescence>0,$=E.sheen>0,_t=E.transmission>0,ot=_&&!!E.anisotropyMap,ht=B&&!!E.clearcoatMap,Gt=B&&!!E.clearcoatNormalMap,Q=B&&!!E.clearcoatRoughnessMap,ft=Z&&!!E.iridescenceMap,Tt=Z&&!!E.iridescenceThicknessMap,Rt=$&&!!E.sheenColorMap,pt=$&&!!E.sheenRoughnessMap,Ht=!!E.specularMap,Lt=!!E.specularColorMap,re=!!E.specularIntensityMap,P=_t&&!!E.transmissionMap,at=_t&&!!E.thicknessMap,V=!!E.gradientMap,K=!!E.alphaMap,lt=E.alphaTest>0,ct=!!E.alphaHash,It=!!E.extensions;let le=ii;E.toneMapped&&(st===null||st.isXRRenderTarget===!0)&&(le=n.toneMapping);const Ae={shaderID:et,shaderType:E.type,shaderName:E.name,vertexShader:ie,fragmentShader:Y,defines:E.defines,customVertexShaderID:tt,customFragmentShaderID:gt,isRawShaderMaterial:E.isRawShaderMaterial===!0,glslVersion:E.glslVersion,precision:p,batching:At,batchingColor:At&&O._colorsTexture!==null,instancing:jt,instancingColor:jt&&O.instanceColor!==null,instancingMorph:jt&&O.morphTexture!==null,supportsVertexTextures:h,outputColorSpace:st===null?n.outputColorSpace:st.isXRRenderTarget===!0?st.texture.colorSpace:xr,alphaToCoverage:!!E.alphaToCoverage,map:fe,matcap:ce,envMap:kt,envMapMode:kt&&q.mapping,envMapCubeUVHeight:H,aoMap:C,lightMap:je,bumpMap:Vt,normalMap:zt,displacementMap:h&&xt,emissiveMap:se,normalMapObjectSpace:zt&&E.normalMapType===Ep,normalMapTangentSpace:zt&&E.normalMapType===jd,metalnessMap:vt,roughnessMap:M,anisotropy:_,anisotropyMap:ot,clearcoat:B,clearcoatMap:ht,clearcoatNormalMap:Gt,clearcoatRoughnessMap:Q,dispersion:j,iridescence:Z,iridescenceMap:ft,iridescenceThicknessMap:Tt,sheen:$,sheenColorMap:Rt,sheenRoughnessMap:pt,specularMap:Ht,specularColorMap:Lt,specularIntensityMap:re,transmission:_t,transmissionMap:P,thicknessMap:at,gradientMap:V,opaque:E.transparent===!1&&E.blending===mr&&E.alphaToCoverage===!1,alphaMap:K,alphaTest:lt,alphaHash:ct,combine:E.combine,mapUv:fe&&v(E.map.channel),aoMapUv:C&&v(E.aoMap.channel),lightMapUv:je&&v(E.lightMap.channel),bumpMapUv:Vt&&v(E.bumpMap.channel),normalMapUv:zt&&v(E.normalMap.channel),displacementMapUv:xt&&v(E.displacementMap.channel),emissiveMapUv:se&&v(E.emissiveMap.channel),metalnessMapUv:vt&&v(E.metalnessMap.channel),roughnessMapUv:M&&v(E.roughnessMap.channel),anisotropyMapUv:ot&&v(E.anisotropyMap.channel),clearcoatMapUv:ht&&v(E.clearcoatMap.channel),clearcoatNormalMapUv:Gt&&v(E.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Q&&v(E.clearcoatRoughnessMap.channel),iridescenceMapUv:ft&&v(E.iridescenceMap.channel),iridescenceThicknessMapUv:Tt&&v(E.iridescenceThicknessMap.channel),sheenColorMapUv:Rt&&v(E.sheenColorMap.channel),sheenRoughnessMapUv:pt&&v(E.sheenRoughnessMap.channel),specularMapUv:Ht&&v(E.specularMap.channel),specularColorMapUv:Lt&&v(E.specularColorMap.channel),specularIntensityMapUv:re&&v(E.specularIntensityMap.channel),transmissionMapUv:P&&v(E.transmissionMap.channel),thicknessMapUv:at&&v(E.thicknessMap.channel),alphaMapUv:K&&v(E.alphaMap.channel),vertexTangents:!!X.attributes.tangent&&(zt||_),vertexColors:E.vertexColors,vertexAlphas:E.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!X.attributes.uv&&(fe||K),fog:!!W,useFog:E.fog===!0,fogExp2:!!W&&W.isFogExp2,flatShading:E.flatShading===!0,sizeAttenuation:E.sizeAttenuation===!0,logarithmicDepthBuffer:d,reverseDepthBuffer:bt,skinning:O.isSkinnedMesh===!0,morphTargets:X.morphAttributes.position!==void 0,morphNormals:X.morphAttributes.normal!==void 0,morphColors:X.morphAttributes.color!==void 0,morphTargetsCount:St,morphTextureStride:Ot,numDirLights:x.directional.length,numPointLights:x.point.length,numSpotLights:x.spot.length,numSpotLightMaps:x.spotLightMap.length,numRectAreaLights:x.rectArea.length,numHemiLights:x.hemi.length,numDirLightShadows:x.directionalShadowMap.length,numPointLightShadows:x.pointShadowMap.length,numSpotLightShadows:x.spotShadowMap.length,numSpotLightShadowsWithMaps:x.numSpotLightShadowsWithMaps,numLightProbes:x.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:E.dithering,shadowMapEnabled:n.shadowMap.enabled&&A.length>0,shadowMapType:n.shadowMap.type,toneMapping:le,decodeVideoTexture:fe&&E.map.isVideoTexture===!0&&Yt.getTransfer(E.map.colorSpace)===te,decodeVideoTextureEmissive:se&&E.emissiveMap.isVideoTexture===!0&&Yt.getTransfer(E.emissiveMap.colorSpace)===te,premultipliedAlpha:E.premultipliedAlpha,doubleSided:E.side===Nn,flipSided:E.side===Ve,useDepthPacking:E.depthPacking>=0,depthPacking:E.depthPacking||0,index0AttributeName:E.index0AttributeName,extensionClipCullDistance:It&&E.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(It&&E.extensions.multiDraw===!0||At)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:E.customProgramCacheKey()};return Ae.vertexUv1s=l.has(1),Ae.vertexUv2s=l.has(2),Ae.vertexUv3s=l.has(3),l.clear(),Ae}function f(E){const x=[];if(E.shaderID?x.push(E.shaderID):(x.push(E.customVertexShaderID),x.push(E.customFragmentShaderID)),E.defines!==void 0)for(const A in E.defines)x.push(A),x.push(E.defines[A]);return E.isRawShaderMaterial===!1&&(T(x,E),b(x,E),x.push(n.outputColorSpace)),x.push(E.customProgramCacheKey),x.join()}function T(E,x){E.push(x.precision),E.push(x.outputColorSpace),E.push(x.envMapMode),E.push(x.envMapCubeUVHeight),E.push(x.mapUv),E.push(x.alphaMapUv),E.push(x.lightMapUv),E.push(x.aoMapUv),E.push(x.bumpMapUv),E.push(x.normalMapUv),E.push(x.displacementMapUv),E.push(x.emissiveMapUv),E.push(x.metalnessMapUv),E.push(x.roughnessMapUv),E.push(x.anisotropyMapUv),E.push(x.clearcoatMapUv),E.push(x.clearcoatNormalMapUv),E.push(x.clearcoatRoughnessMapUv),E.push(x.iridescenceMapUv),E.push(x.iridescenceThicknessMapUv),E.push(x.sheenColorMapUv),E.push(x.sheenRoughnessMapUv),E.push(x.specularMapUv),E.push(x.specularColorMapUv),E.push(x.specularIntensityMapUv),E.push(x.transmissionMapUv),E.push(x.thicknessMapUv),E.push(x.combine),E.push(x.fogExp2),E.push(x.sizeAttenuation),E.push(x.morphTargetsCount),E.push(x.morphAttributeCount),E.push(x.numDirLights),E.push(x.numPointLights),E.push(x.numSpotLights),E.push(x.numSpotLightMaps),E.push(x.numHemiLights),E.push(x.numRectAreaLights),E.push(x.numDirLightShadows),E.push(x.numPointLightShadows),E.push(x.numSpotLightShadows),E.push(x.numSpotLightShadowsWithMaps),E.push(x.numLightProbes),E.push(x.shadowMapType),E.push(x.toneMapping),E.push(x.numClippingPlanes),E.push(x.numClipIntersection),E.push(x.depthPacking)}function b(E,x){a.disableAll(),x.supportsVertexTextures&&a.enable(0),x.instancing&&a.enable(1),x.instancingColor&&a.enable(2),x.instancingMorph&&a.enable(3),x.matcap&&a.enable(4),x.envMap&&a.enable(5),x.normalMapObjectSpace&&a.enable(6),x.normalMapTangentSpace&&a.enable(7),x.clearcoat&&a.enable(8),x.iridescence&&a.enable(9),x.alphaTest&&a.enable(10),x.vertexColors&&a.enable(11),x.vertexAlphas&&a.enable(12),x.vertexUv1s&&a.enable(13),x.vertexUv2s&&a.enable(14),x.vertexUv3s&&a.enable(15),x.vertexTangents&&a.enable(16),x.anisotropy&&a.enable(17),x.alphaHash&&a.enable(18),x.batching&&a.enable(19),x.dispersion&&a.enable(20),x.batchingColor&&a.enable(21),E.push(a.mask),a.disableAll(),x.fog&&a.enable(0),x.useFog&&a.enable(1),x.flatShading&&a.enable(2),x.logarithmicDepthBuffer&&a.enable(3),x.reverseDepthBuffer&&a.enable(4),x.skinning&&a.enable(5),x.morphTargets&&a.enable(6),x.morphNormals&&a.enable(7),x.morphColors&&a.enable(8),x.premultipliedAlpha&&a.enable(9),x.shadowMapEnabled&&a.enable(10),x.doubleSided&&a.enable(11),x.flipSided&&a.enable(12),x.useDepthPacking&&a.enable(13),x.dithering&&a.enable(14),x.transmission&&a.enable(15),x.sheen&&a.enable(16),x.opaque&&a.enable(17),x.pointsUvs&&a.enable(18),x.decodeVideoTexture&&a.enable(19),x.decodeVideoTextureEmissive&&a.enable(20),x.alphaToCoverage&&a.enable(21),E.push(a.mask)}function y(E){const x=g[E.type];let A;if(x){const N=xn[x];A=go.clone(N.uniforms)}else A=E.uniforms;return A}function I(E,x){let A;for(let N=0,O=u.length;N<O;N++){const W=u[N];if(W.cacheKey===x){A=W,++A.usedTimes;break}}return A===void 0&&(A=new V0(n,x,E,s),u.push(A)),A}function w(E){if(--E.usedTimes===0){const x=u.indexOf(E);u[x]=u[u.length-1],u.pop(),E.destroy()}}function R(E){c.remove(E)}function U(){c.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:y,acquireProgram:I,releaseProgram:w,releaseShaderCache:R,programs:u,dispose:U}}function Y0(){let n=new WeakMap;function t(o){return n.has(o)}function e(o){let a=n.get(o);return a===void 0&&(a={},n.set(o,a)),a}function i(o){n.delete(o)}function r(o,a,c){n.get(o)[a]=c}function s(){n=new WeakMap}return{has:t,get:e,remove:i,update:r,dispose:s}}function q0(n,t){return n.groupOrder!==t.groupOrder?n.groupOrder-t.groupOrder:n.renderOrder!==t.renderOrder?n.renderOrder-t.renderOrder:n.material.id!==t.material.id?n.material.id-t.material.id:n.z!==t.z?n.z-t.z:n.id-t.id}function Pu(n,t){return n.groupOrder!==t.groupOrder?n.groupOrder-t.groupOrder:n.renderOrder!==t.renderOrder?n.renderOrder-t.renderOrder:n.z!==t.z?t.z-n.z:n.id-t.id}function Iu(){const n=[];let t=0;const e=[],i=[],r=[];function s(){t=0,e.length=0,i.length=0,r.length=0}function o(d,h,p,g,v,m){let f=n[t];return f===void 0?(f={id:d.id,object:d,geometry:h,material:p,groupOrder:g,renderOrder:d.renderOrder,z:v,group:m},n[t]=f):(f.id=d.id,f.object=d,f.geometry=h,f.material=p,f.groupOrder=g,f.renderOrder=d.renderOrder,f.z=v,f.group=m),t++,f}function a(d,h,p,g,v,m){const f=o(d,h,p,g,v,m);p.transmission>0?i.push(f):p.transparent===!0?r.push(f):e.push(f)}function c(d,h,p,g,v,m){const f=o(d,h,p,g,v,m);p.transmission>0?i.unshift(f):p.transparent===!0?r.unshift(f):e.unshift(f)}function l(d,h){e.length>1&&e.sort(d||q0),i.length>1&&i.sort(h||Pu),r.length>1&&r.sort(h||Pu)}function u(){for(let d=t,h=n.length;d<h;d++){const p=n[d];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:e,transmissive:i,transparent:r,init:s,push:a,unshift:c,finish:u,sort:l}}function j0(){let n=new WeakMap;function t(i,r){const s=n.get(i);let o;return s===void 0?(o=new Iu,n.set(i,[o])):r>=s.length?(o=new Iu,s.push(o)):o=s[r],o}function e(){n=new WeakMap}return{get:t,dispose:e}}function K0(){const n={};return{get:function(t){if(n[t.id]!==void 0)return n[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new F,color:new Bt};break;case"SpotLight":e={position:new F,direction:new F,color:new Bt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new F,color:new Bt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new F,skyColor:new Bt,groundColor:new Bt};break;case"RectAreaLight":e={color:new Bt,position:new F,halfWidth:new F,halfHeight:new F};break}return n[t.id]=e,e}}}function Z0(){const n={};return{get:function(t){if(n[t.id]!==void 0)return n[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new yt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new yt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new yt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[t.id]=e,e}}}let J0=0;function Q0(n,t){return(t.castShadow?2:0)-(n.castShadow?2:0)+(t.map?1:0)-(n.map?1:0)}function tS(n){const t=new K0,e=Z0(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)i.probe.push(new F);const r=new F,s=new he,o=new he;function a(l){let u=0,d=0,h=0;for(let E=0;E<9;E++)i.probe[E].set(0,0,0);let p=0,g=0,v=0,m=0,f=0,T=0,b=0,y=0,I=0,w=0,R=0;l.sort(Q0);for(let E=0,x=l.length;E<x;E++){const A=l[E],N=A.color,O=A.intensity,W=A.distance,X=A.shadow&&A.shadow.map?A.shadow.map.texture:null;if(A.isAmbientLight)u+=N.r*O,d+=N.g*O,h+=N.b*O;else if(A.isLightProbe){for(let G=0;G<9;G++)i.probe[G].addScaledVector(A.sh.coefficients[G],O);R++}else if(A.isDirectionalLight){const G=t.get(A);if(G.color.copy(A.color).multiplyScalar(A.intensity),A.castShadow){const q=A.shadow,H=e.get(A);H.shadowIntensity=q.intensity,H.shadowBias=q.bias,H.shadowNormalBias=q.normalBias,H.shadowRadius=q.radius,H.shadowMapSize=q.mapSize,i.directionalShadow[p]=H,i.directionalShadowMap[p]=X,i.directionalShadowMatrix[p]=A.shadow.matrix,T++}i.directional[p]=G,p++}else if(A.isSpotLight){const G=t.get(A);G.position.setFromMatrixPosition(A.matrixWorld),G.color.copy(N).multiplyScalar(O),G.distance=W,G.coneCos=Math.cos(A.angle),G.penumbraCos=Math.cos(A.angle*(1-A.penumbra)),G.decay=A.decay,i.spot[v]=G;const q=A.shadow;if(A.map&&(i.spotLightMap[I]=A.map,I++,q.updateMatrices(A),A.castShadow&&w++),i.spotLightMatrix[v]=q.matrix,A.castShadow){const H=e.get(A);H.shadowIntensity=q.intensity,H.shadowBias=q.bias,H.shadowNormalBias=q.normalBias,H.shadowRadius=q.radius,H.shadowMapSize=q.mapSize,i.spotShadow[v]=H,i.spotShadowMap[v]=X,y++}v++}else if(A.isRectAreaLight){const G=t.get(A);G.color.copy(N).multiplyScalar(O),G.halfWidth.set(A.width*.5,0,0),G.halfHeight.set(0,A.height*.5,0),i.rectArea[m]=G,m++}else if(A.isPointLight){const G=t.get(A);if(G.color.copy(A.color).multiplyScalar(A.intensity),G.distance=A.distance,G.decay=A.decay,A.castShadow){const q=A.shadow,H=e.get(A);H.shadowIntensity=q.intensity,H.shadowBias=q.bias,H.shadowNormalBias=q.normalBias,H.shadowRadius=q.radius,H.shadowMapSize=q.mapSize,H.shadowCameraNear=q.camera.near,H.shadowCameraFar=q.camera.far,i.pointShadow[g]=H,i.pointShadowMap[g]=X,i.pointShadowMatrix[g]=A.shadow.matrix,b++}i.point[g]=G,g++}else if(A.isHemisphereLight){const G=t.get(A);G.skyColor.copy(A.color).multiplyScalar(O),G.groundColor.copy(A.groundColor).multiplyScalar(O),i.hemi[f]=G,f++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=nt.LTC_FLOAT_1,i.rectAreaLTC2=nt.LTC_FLOAT_2):(i.rectAreaLTC1=nt.LTC_HALF_1,i.rectAreaLTC2=nt.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=d,i.ambient[2]=h;const U=i.hash;(U.directionalLength!==p||U.pointLength!==g||U.spotLength!==v||U.rectAreaLength!==m||U.hemiLength!==f||U.numDirectionalShadows!==T||U.numPointShadows!==b||U.numSpotShadows!==y||U.numSpotMaps!==I||U.numLightProbes!==R)&&(i.directional.length=p,i.spot.length=v,i.rectArea.length=m,i.point.length=g,i.hemi.length=f,i.directionalShadow.length=T,i.directionalShadowMap.length=T,i.pointShadow.length=b,i.pointShadowMap.length=b,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=T,i.pointShadowMatrix.length=b,i.spotLightMatrix.length=y+I-w,i.spotLightMap.length=I,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=R,U.directionalLength=p,U.pointLength=g,U.spotLength=v,U.rectAreaLength=m,U.hemiLength=f,U.numDirectionalShadows=T,U.numPointShadows=b,U.numSpotShadows=y,U.numSpotMaps=I,U.numLightProbes=R,i.version=J0++)}function c(l,u){let d=0,h=0,p=0,g=0,v=0;const m=u.matrixWorldInverse;for(let f=0,T=l.length;f<T;f++){const b=l[f];if(b.isDirectionalLight){const y=i.directional[d];y.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),d++}else if(b.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),p++}else if(b.isRectAreaLight){const y=i.rectArea[g];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),o.identity(),s.copy(b.matrixWorld),s.premultiply(m),o.extractRotation(s),y.halfWidth.set(b.width*.5,0,0),y.halfHeight.set(0,b.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),g++}else if(b.isPointLight){const y=i.point[h];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),h++}else if(b.isHemisphereLight){const y=i.hemi[v];y.direction.setFromMatrixPosition(b.matrixWorld),y.direction.transformDirection(m),v++}}}return{setup:a,setupView:c,state:i}}function Du(n){const t=new tS(n),e=[],i=[];function r(u){l.camera=u,e.length=0,i.length=0}function s(u){e.push(u)}function o(u){i.push(u)}function a(){t.setup(e)}function c(u){t.setupView(e,u)}const l={lightsArray:e,shadowsArray:i,camera:null,lights:t,transmissionRenderTarget:{}};return{init:r,state:l,setupLights:a,setupLightsView:c,pushLight:s,pushShadow:o}}function eS(n){let t=new WeakMap;function e(r,s=0){const o=t.get(r);let a;return o===void 0?(a=new Du(n),t.set(r,[a])):s>=o.length?(a=new Du(n),o.push(a)):a=o[s],a}function i(){t=new WeakMap}return{get:e,dispose:i}}const nS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function rS(n,t,e){let i=new el;const r=new yt,s=new yt,o=new de,a=new Em({depthPacking:xp}),c=new ym,l={},u=e.maxTextureSize,d={[si]:Ve,[Ve]:si,[Nn]:Nn},h=new Ue({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new yt},radius:{value:4}},vertexShader:nS,fragmentShader:iS}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const g=new qn;g.setAttribute("position",new yn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new He(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Fd;let f=this.type;this.render=function(w,R,U){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const E=n.getRenderTarget(),x=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),N=n.state;N.setBlending(kn),N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const O=f!==In&&this.type===In,W=f===In&&this.type!==In;for(let X=0,G=w.length;X<G;X++){const q=w[X],H=q.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const et=H.getFrameExtents();if(r.multiply(et),s.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/et.x),r.x=s.x*et.x,H.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/et.y),r.y=s.y*et.y,H.mapSize.y=s.y)),H.map===null||O===!0||W===!0){const St=this.type!==In?{minFilter:pn,magFilter:pn}:{};H.map!==null&&H.map.dispose(),H.map=new mn(r.x,r.y,St),H.map.texture.name=q.name+".shadowMap",H.camera.updateProjectionMatrix()}n.setRenderTarget(H.map),n.clear();const dt=H.getViewportCount();for(let St=0;St<dt;St++){const Ot=H.getViewport(St);o.set(s.x*Ot.x,s.y*Ot.y,s.x*Ot.z,s.y*Ot.w),N.viewport(o),H.updateMatrices(q,St),i=H.getFrustum(),y(R,U,H.camera,q,this.type)}H.isPointLightShadow!==!0&&this.type===In&&T(H,U),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(E,x,A)};function T(w,R){const U=t.update(v);h.defines.VSM_SAMPLES!==w.blurSamples&&(h.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new mn(r.x,r.y)),h.uniforms.shadow_pass.value=w.map.texture,h.uniforms.resolution.value=w.mapSize,h.uniforms.radius.value=w.radius,n.setRenderTarget(w.mapPass),n.clear(),n.renderBufferDirect(R,null,U,h,v,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,n.setRenderTarget(w.map),n.clear(),n.renderBufferDirect(R,null,U,p,v,null)}function b(w,R,U,E){let x=null;const A=U.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(A!==void 0)x=A;else if(x=U.isPointLight===!0?c:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const N=x.uuid,O=R.uuid;let W=l[N];W===void 0&&(W={},l[N]=W);let X=W[O];X===void 0&&(X=x.clone(),W[O]=X,R.addEventListener("dispose",I)),x=X}if(x.visible=R.visible,x.wireframe=R.wireframe,E===In?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:d[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,U.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const N=n.properties.get(x);N.light=U}return x}function y(w,R,U,E,x){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&x===In)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,w.matrixWorld);const O=t.update(w),W=w.material;if(Array.isArray(W)){const X=O.groups;for(let G=0,q=X.length;G<q;G++){const H=X[G],et=W[H.materialIndex];if(et&&et.visible){const dt=b(w,et,E,x);w.onBeforeShadow(n,w,R,U,O,dt,H),n.renderBufferDirect(U,null,O,dt,w,H),w.onAfterShadow(n,w,R,U,O,dt,H)}}}else if(W.visible){const X=b(w,W,E,x);w.onBeforeShadow(n,w,R,U,O,X,null),n.renderBufferDirect(U,null,O,X,w,null),w.onAfterShadow(n,w,R,U,O,X,null)}}const N=w.children;for(let O=0,W=N.length;O<W;O++)y(N[O],R,U,E,x)}function I(w){w.target.removeEventListener("dispose",I);for(const U in l){const E=l[U],x=w.target.uuid;x in E&&(E[x].dispose(),delete E[x])}}}const sS={[Fa]:Oa,[Ba]:Ha,[ka]:Va,[_r]:za,[Oa]:Fa,[Ha]:Ba,[Va]:ka,[za]:_r};function oS(n,t){function e(){let P=!1;const at=new de;let V=null;const K=new de(0,0,0,0);return{setMask:function(lt){V!==lt&&!P&&(n.colorMask(lt,lt,lt,lt),V=lt)},setLocked:function(lt){P=lt},setClear:function(lt,ct,It,le,Ae){Ae===!0&&(lt*=le,ct*=le,It*=le),at.set(lt,ct,It,le),K.equals(at)===!1&&(n.clearColor(lt,ct,It,le),K.copy(at))},reset:function(){P=!1,V=null,K.set(-1,0,0,0)}}}function i(){let P=!1,at=!1,V=null,K=null,lt=null;return{setReversed:function(ct){if(at!==ct){const It=t.get("EXT_clip_control");ct?It.clipControlEXT(It.LOWER_LEFT_EXT,It.ZERO_TO_ONE_EXT):It.clipControlEXT(It.LOWER_LEFT_EXT,It.NEGATIVE_ONE_TO_ONE_EXT),at=ct;const le=lt;lt=null,this.setClear(le)}},getReversed:function(){return at},setTest:function(ct){ct?st(n.DEPTH_TEST):bt(n.DEPTH_TEST)},setMask:function(ct){V!==ct&&!P&&(n.depthMask(ct),V=ct)},setFunc:function(ct){if(at&&(ct=sS[ct]),K!==ct){switch(ct){case Fa:n.depthFunc(n.NEVER);break;case Oa:n.depthFunc(n.ALWAYS);break;case Ba:n.depthFunc(n.LESS);break;case _r:n.depthFunc(n.LEQUAL);break;case ka:n.depthFunc(n.EQUAL);break;case za:n.depthFunc(n.GEQUAL);break;case Ha:n.depthFunc(n.GREATER);break;case Va:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}K=ct}},setLocked:function(ct){P=ct},setClear:function(ct){lt!==ct&&(at&&(ct=1-ct),n.clearDepth(ct),lt=ct)},reset:function(){P=!1,V=null,K=null,lt=null,at=!1}}}function r(){let P=!1,at=null,V=null,K=null,lt=null,ct=null,It=null,le=null,Ae=null;return{setTest:function(Jt){P||(Jt?st(n.STENCIL_TEST):bt(n.STENCIL_TEST))},setMask:function(Jt){at!==Jt&&!P&&(n.stencilMask(Jt),at=Jt)},setFunc:function(Jt,an,Tn){(V!==Jt||K!==an||lt!==Tn)&&(n.stencilFunc(Jt,an,Tn),V=Jt,K=an,lt=Tn)},setOp:function(Jt,an,Tn){(ct!==Jt||It!==an||le!==Tn)&&(n.stencilOp(Jt,an,Tn),ct=Jt,It=an,le=Tn)},setLocked:function(Jt){P=Jt},setClear:function(Jt){Ae!==Jt&&(n.clearStencil(Jt),Ae=Jt)},reset:function(){P=!1,at=null,V=null,K=null,lt=null,ct=null,It=null,le=null,Ae=null}}}const s=new e,o=new i,a=new r,c=new WeakMap,l=new WeakMap;let u={},d={},h=new WeakMap,p=[],g=null,v=!1,m=null,f=null,T=null,b=null,y=null,I=null,w=null,R=new Bt(0,0,0),U=0,E=!1,x=null,A=null,N=null,O=null,W=null;const X=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,q=0;const H=n.getParameter(n.VERSION);H.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(H)[1]),G=q>=1):H.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),G=q>=2);let et=null,dt={};const St=n.getParameter(n.SCISSOR_BOX),Ot=n.getParameter(n.VIEWPORT),ie=new de().fromArray(St),Y=new de().fromArray(Ot);function tt(P,at,V,K){const lt=new Uint8Array(4),ct=n.createTexture();n.bindTexture(P,ct),n.texParameteri(P,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(P,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let It=0;It<V;It++)P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY?n.texImage3D(at,0,n.RGBA,1,1,K,0,n.RGBA,n.UNSIGNED_BYTE,lt):n.texImage2D(at+It,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,lt);return ct}const gt={};gt[n.TEXTURE_2D]=tt(n.TEXTURE_2D,n.TEXTURE_2D,1),gt[n.TEXTURE_CUBE_MAP]=tt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),gt[n.TEXTURE_2D_ARRAY]=tt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),gt[n.TEXTURE_3D]=tt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),st(n.DEPTH_TEST),o.setFunc(_r),Vt(!1),zt(Ll),st(n.CULL_FACE),C(kn);function st(P){u[P]!==!0&&(n.enable(P),u[P]=!0)}function bt(P){u[P]!==!1&&(n.disable(P),u[P]=!1)}function jt(P,at){return d[P]!==at?(n.bindFramebuffer(P,at),d[P]=at,P===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=at),P===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=at),!0):!1}function At(P,at){let V=p,K=!1;if(P){V=h.get(at),V===void 0&&(V=[],h.set(at,V));const lt=P.textures;if(V.length!==lt.length||V[0]!==n.COLOR_ATTACHMENT0){for(let ct=0,It=lt.length;ct<It;ct++)V[ct]=n.COLOR_ATTACHMENT0+ct;V.length=lt.length,K=!0}}else V[0]!==n.BACK&&(V[0]=n.BACK,K=!0);K&&n.drawBuffers(V)}function fe(P){return g!==P?(n.useProgram(P),g=P,!0):!1}const ce={[yi]:n.FUNC_ADD,[$f]:n.FUNC_SUBTRACT,[Yf]:n.FUNC_REVERSE_SUBTRACT};ce[qf]=n.MIN,ce[jf]=n.MAX;const kt={[Kf]:n.ZERO,[Zf]:n.ONE,[Jf]:n.SRC_COLOR,[Ua]:n.SRC_ALPHA,[rp]:n.SRC_ALPHA_SATURATE,[np]:n.DST_COLOR,[tp]:n.DST_ALPHA,[Qf]:n.ONE_MINUS_SRC_COLOR,[Na]:n.ONE_MINUS_SRC_ALPHA,[ip]:n.ONE_MINUS_DST_COLOR,[ep]:n.ONE_MINUS_DST_ALPHA,[sp]:n.CONSTANT_COLOR,[op]:n.ONE_MINUS_CONSTANT_COLOR,[ap]:n.CONSTANT_ALPHA,[cp]:n.ONE_MINUS_CONSTANT_ALPHA};function C(P,at,V,K,lt,ct,It,le,Ae,Jt){if(P===kn){v===!0&&(bt(n.BLEND),v=!1);return}if(v===!1&&(st(n.BLEND),v=!0),P!==Xf){if(P!==m||Jt!==E){if((f!==yi||y!==yi)&&(n.blendEquation(n.FUNC_ADD),f=yi,y=yi),Jt)switch(P){case mr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case La:n.blendFunc(n.ONE,n.ONE);break;case Ul:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nl:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case mr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case La:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ul:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nl:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}T=null,b=null,I=null,w=null,R.set(0,0,0),U=0,m=P,E=Jt}return}lt=lt||at,ct=ct||V,It=It||K,(at!==f||lt!==y)&&(n.blendEquationSeparate(ce[at],ce[lt]),f=at,y=lt),(V!==T||K!==b||ct!==I||It!==w)&&(n.blendFuncSeparate(kt[V],kt[K],kt[ct],kt[It]),T=V,b=K,I=ct,w=It),(le.equals(R)===!1||Ae!==U)&&(n.blendColor(le.r,le.g,le.b,Ae),R.copy(le),U=Ae),m=P,E=!1}function je(P,at){P.side===Nn?bt(n.CULL_FACE):st(n.CULL_FACE);let V=P.side===Ve;at&&(V=!V),Vt(V),P.blending===mr&&P.transparent===!1?C(kn):C(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),o.setFunc(P.depthFunc),o.setTest(P.depthTest),o.setMask(P.depthWrite),s.setMask(P.colorWrite);const K=P.stencilWrite;a.setTest(K),K&&(a.setMask(P.stencilWriteMask),a.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),a.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),se(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?st(n.SAMPLE_ALPHA_TO_COVERAGE):bt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Vt(P){x!==P&&(P?n.frontFace(n.CW):n.frontFace(n.CCW),x=P)}function zt(P){P!==Vf?(st(n.CULL_FACE),P!==A&&(P===Ll?n.cullFace(n.BACK):P===Gf?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):bt(n.CULL_FACE),A=P}function xt(P){P!==N&&(G&&n.lineWidth(P),N=P)}function se(P,at,V){P?(st(n.POLYGON_OFFSET_FILL),(O!==at||W!==V)&&(n.polygonOffset(at,V),O=at,W=V)):bt(n.POLYGON_OFFSET_FILL)}function vt(P){P?st(n.SCISSOR_TEST):bt(n.SCISSOR_TEST)}function M(P){P===void 0&&(P=n.TEXTURE0+X-1),et!==P&&(n.activeTexture(P),et=P)}function _(P,at,V){V===void 0&&(et===null?V=n.TEXTURE0+X-1:V=et);let K=dt[V];K===void 0&&(K={type:void 0,texture:void 0},dt[V]=K),(K.type!==P||K.texture!==at)&&(et!==V&&(n.activeTexture(V),et=V),n.bindTexture(P,at||gt[P]),K.type=P,K.texture=at)}function B(){const P=dt[et];P!==void 0&&P.type!==void 0&&(n.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function j(){try{n.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Z(){try{n.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function $(){try{n.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function _t(){try{n.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ot(){try{n.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ht(){try{n.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Gt(){try{n.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Q(){try{n.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ft(){try{n.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Tt(){try{n.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Rt(P){ie.equals(P)===!1&&(n.scissor(P.x,P.y,P.z,P.w),ie.copy(P))}function pt(P){Y.equals(P)===!1&&(n.viewport(P.x,P.y,P.z,P.w),Y.copy(P))}function Ht(P,at){let V=l.get(at);V===void 0&&(V=new WeakMap,l.set(at,V));let K=V.get(P);K===void 0&&(K=n.getUniformBlockIndex(at,P.name),V.set(P,K))}function Lt(P,at){const K=l.get(at).get(P);c.get(at)!==K&&(n.uniformBlockBinding(at,K,P.__bindingPointIndex),c.set(at,K))}function re(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},et=null,dt={},d={},h=new WeakMap,p=[],g=null,v=!1,m=null,f=null,T=null,b=null,y=null,I=null,w=null,R=new Bt(0,0,0),U=0,E=!1,x=null,A=null,N=null,O=null,W=null,ie.set(0,0,n.canvas.width,n.canvas.height),Y.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:st,disable:bt,bindFramebuffer:jt,drawBuffers:At,useProgram:fe,setBlending:C,setMaterial:je,setFlipSided:Vt,setCullFace:zt,setLineWidth:xt,setPolygonOffset:se,setScissorTest:vt,activeTexture:M,bindTexture:_,unbindTexture:B,compressedTexImage2D:j,compressedTexImage3D:Z,texImage2D:ft,texImage3D:Tt,updateUBOMapping:Ht,uniformBlockBinding:Lt,texStorage2D:Gt,texStorage3D:Q,texSubImage2D:$,texSubImage3D:_t,compressedTexSubImage2D:ot,compressedTexSubImage3D:ht,scissor:Rt,viewport:pt,reset:re}}function aS(n,t,e,i,r,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new yt,u=new WeakMap;let d;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(M,_){return p?new OffscreenCanvas(M,_):Jr("canvas")}function v(M,_,B){let j=1;const Z=vt(M);if((Z.width>B||Z.height>B)&&(j=B/Math.max(Z.width,Z.height)),j<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const $=Math.floor(j*Z.width),_t=Math.floor(j*Z.height);d===void 0&&(d=g($,_t));const ot=_?g($,_t):d;return ot.width=$,ot.height=_t,ot.getContext("2d").drawImage(M,0,0,$,_t),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+$+"x"+_t+")."),ot}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),M;return M}function m(M){return M.generateMipmaps}function f(M){n.generateMipmap(M)}function T(M){return M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?n.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(M,_,B,j,Z=!1){if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let $=_;if(_===n.RED&&(B===n.FLOAT&&($=n.R32F),B===n.HALF_FLOAT&&($=n.R16F),B===n.UNSIGNED_BYTE&&($=n.R8)),_===n.RED_INTEGER&&(B===n.UNSIGNED_BYTE&&($=n.R8UI),B===n.UNSIGNED_SHORT&&($=n.R16UI),B===n.UNSIGNED_INT&&($=n.R32UI),B===n.BYTE&&($=n.R8I),B===n.SHORT&&($=n.R16I),B===n.INT&&($=n.R32I)),_===n.RG&&(B===n.FLOAT&&($=n.RG32F),B===n.HALF_FLOAT&&($=n.RG16F),B===n.UNSIGNED_BYTE&&($=n.RG8)),_===n.RG_INTEGER&&(B===n.UNSIGNED_BYTE&&($=n.RG8UI),B===n.UNSIGNED_SHORT&&($=n.RG16UI),B===n.UNSIGNED_INT&&($=n.RG32UI),B===n.BYTE&&($=n.RG8I),B===n.SHORT&&($=n.RG16I),B===n.INT&&($=n.RG32I)),_===n.RGB_INTEGER&&(B===n.UNSIGNED_BYTE&&($=n.RGB8UI),B===n.UNSIGNED_SHORT&&($=n.RGB16UI),B===n.UNSIGNED_INT&&($=n.RGB32UI),B===n.BYTE&&($=n.RGB8I),B===n.SHORT&&($=n.RGB16I),B===n.INT&&($=n.RGB32I)),_===n.RGBA_INTEGER&&(B===n.UNSIGNED_BYTE&&($=n.RGBA8UI),B===n.UNSIGNED_SHORT&&($=n.RGBA16UI),B===n.UNSIGNED_INT&&($=n.RGBA32UI),B===n.BYTE&&($=n.RGBA8I),B===n.SHORT&&($=n.RGBA16I),B===n.INT&&($=n.RGBA32I)),_===n.RGB&&B===n.UNSIGNED_INT_5_9_9_9_REV&&($=n.RGB9_E5),_===n.RGBA){const _t=Z?po:Yt.getTransfer(j);B===n.FLOAT&&($=n.RGBA32F),B===n.HALF_FLOAT&&($=n.RGBA16F),B===n.UNSIGNED_BYTE&&($=_t===te?n.SRGB8_ALPHA8:n.RGBA8),B===n.UNSIGNED_SHORT_4_4_4_4&&($=n.RGBA4),B===n.UNSIGNED_SHORT_5_5_5_1&&($=n.RGB5_A1)}return($===n.R16F||$===n.R32F||$===n.RG16F||$===n.RG32F||$===n.RGBA16F||$===n.RGBA32F)&&t.get("EXT_color_buffer_float"),$}function y(M,_){let B;return M?_===null||_===Di||_===qr?B=n.DEPTH24_STENCIL8:_===Fn?B=n.DEPTH32F_STENCIL8:_===Yr&&(B=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Di||_===qr?B=n.DEPTH_COMPONENT24:_===Fn?B=n.DEPTH_COMPONENT32F:_===Yr&&(B=n.DEPTH_COMPONENT16),B}function I(M,_){return m(M)===!0||M.isFramebufferTexture&&M.minFilter!==pn&&M.minFilter!==En?Math.log2(Math.max(_.width,_.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?_.mipmaps.length:1}function w(M){const _=M.target;_.removeEventListener("dispose",w),U(_),_.isVideoTexture&&u.delete(_)}function R(M){const _=M.target;_.removeEventListener("dispose",R),x(_)}function U(M){const _=i.get(M);if(_.__webglInit===void 0)return;const B=M.source,j=h.get(B);if(j){const Z=j[_.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&E(M),Object.keys(j).length===0&&h.delete(B)}i.remove(M)}function E(M){const _=i.get(M);n.deleteTexture(_.__webglTexture);const B=M.source,j=h.get(B);delete j[_.__cacheKey],o.memory.textures--}function x(M){const _=i.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),i.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(_.__webglFramebuffer[j]))for(let Z=0;Z<_.__webglFramebuffer[j].length;Z++)n.deleteFramebuffer(_.__webglFramebuffer[j][Z]);else n.deleteFramebuffer(_.__webglFramebuffer[j]);_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer[j])}else{if(Array.isArray(_.__webglFramebuffer))for(let j=0;j<_.__webglFramebuffer.length;j++)n.deleteFramebuffer(_.__webglFramebuffer[j]);else n.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&n.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let j=0;j<_.__webglColorRenderbuffer.length;j++)_.__webglColorRenderbuffer[j]&&n.deleteRenderbuffer(_.__webglColorRenderbuffer[j]);_.__webglDepthRenderbuffer&&n.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const B=M.textures;for(let j=0,Z=B.length;j<Z;j++){const $=i.get(B[j]);$.__webglTexture&&(n.deleteTexture($.__webglTexture),o.memory.textures--),i.remove(B[j])}i.remove(M)}let A=0;function N(){A=0}function O(){const M=A;return M>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),A+=1,M}function W(M){const _=[];return _.push(M.wrapS),_.push(M.wrapT),_.push(M.wrapR||0),_.push(M.magFilter),_.push(M.minFilter),_.push(M.anisotropy),_.push(M.internalFormat),_.push(M.format),_.push(M.type),_.push(M.generateMipmaps),_.push(M.premultiplyAlpha),_.push(M.flipY),_.push(M.unpackAlignment),_.push(M.colorSpace),_.join()}function X(M,_){const B=i.get(M);if(M.isVideoTexture&&xt(M),M.isRenderTargetTexture===!1&&M.version>0&&B.__version!==M.version){const j=M.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(B,M,_);return}}e.bindTexture(n.TEXTURE_2D,B.__webglTexture,n.TEXTURE0+_)}function G(M,_){const B=i.get(M);if(M.version>0&&B.__version!==M.version){Y(B,M,_);return}e.bindTexture(n.TEXTURE_2D_ARRAY,B.__webglTexture,n.TEXTURE0+_)}function q(M,_){const B=i.get(M);if(M.version>0&&B.__version!==M.version){Y(B,M,_);return}e.bindTexture(n.TEXTURE_3D,B.__webglTexture,n.TEXTURE0+_)}function H(M,_){const B=i.get(M);if(M.version>0&&B.__version!==M.version){tt(B,M,_);return}e.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture,n.TEXTURE0+_)}const et={[Xa]:n.REPEAT,[Ti]:n.CLAMP_TO_EDGE,[$a]:n.MIRRORED_REPEAT},dt={[pn]:n.NEAREST,[vp]:n.NEAREST_MIPMAP_NEAREST,[xs]:n.NEAREST_MIPMAP_LINEAR,[En]:n.LINEAR,[ko]:n.LINEAR_MIPMAP_NEAREST,[Ai]:n.LINEAR_MIPMAP_LINEAR},St={[yp]:n.NEVER,[Rp]:n.ALWAYS,[Mp]:n.LESS,[Kd]:n.LEQUAL,[bp]:n.EQUAL,[wp]:n.GEQUAL,[Tp]:n.GREATER,[Ap]:n.NOTEQUAL};function Ot(M,_){if(_.type===Fn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===En||_.magFilter===ko||_.magFilter===xs||_.magFilter===Ai||_.minFilter===En||_.minFilter===ko||_.minFilter===xs||_.minFilter===Ai)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(M,n.TEXTURE_WRAP_S,et[_.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,et[_.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,et[_.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,dt[_.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,dt[_.minFilter]),_.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,St[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===pn||_.minFilter!==xs&&_.minFilter!==Ai||_.type===Fn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");n.texParameterf(M,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function ie(M,_){let B=!1;M.__webglInit===void 0&&(M.__webglInit=!0,_.addEventListener("dispose",w));const j=_.source;let Z=h.get(j);Z===void 0&&(Z={},h.set(j,Z));const $=W(_);if($!==M.__cacheKey){Z[$]===void 0&&(Z[$]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,B=!0),Z[$].usedTimes++;const _t=Z[M.__cacheKey];_t!==void 0&&(Z[M.__cacheKey].usedTimes--,_t.usedTimes===0&&E(_)),M.__cacheKey=$,M.__webglTexture=Z[$].texture}return B}function Y(M,_,B){let j=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(j=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(j=n.TEXTURE_3D);const Z=ie(M,_),$=_.source;e.bindTexture(j,M.__webglTexture,n.TEXTURE0+B);const _t=i.get($);if($.version!==_t.__version||Z===!0){e.activeTexture(n.TEXTURE0+B);const ot=Yt.getPrimaries(Yt.workingColorSpace),ht=_.colorSpace===ni?null:Yt.getPrimaries(_.colorSpace),Gt=_.colorSpace===ni||ot===ht?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);let Q=v(_.image,!1,r.maxTextureSize);Q=se(_,Q);const ft=s.convert(_.format,_.colorSpace),Tt=s.convert(_.type);let Rt=b(_.internalFormat,ft,Tt,_.colorSpace,_.isVideoTexture);Ot(j,_);let pt;const Ht=_.mipmaps,Lt=_.isVideoTexture!==!0,re=_t.__version===void 0||Z===!0,P=$.dataReady,at=I(_,Q);if(_.isDepthTexture)Rt=y(_.format===Kr,_.type),re&&(Lt?e.texStorage2D(n.TEXTURE_2D,1,Rt,Q.width,Q.height):e.texImage2D(n.TEXTURE_2D,0,Rt,Q.width,Q.height,0,ft,Tt,null));else if(_.isDataTexture)if(Ht.length>0){Lt&&re&&e.texStorage2D(n.TEXTURE_2D,at,Rt,Ht[0].width,Ht[0].height);for(let V=0,K=Ht.length;V<K;V++)pt=Ht[V],Lt?P&&e.texSubImage2D(n.TEXTURE_2D,V,0,0,pt.width,pt.height,ft,Tt,pt.data):e.texImage2D(n.TEXTURE_2D,V,Rt,pt.width,pt.height,0,ft,Tt,pt.data);_.generateMipmaps=!1}else Lt?(re&&e.texStorage2D(n.TEXTURE_2D,at,Rt,Q.width,Q.height),P&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,Q.width,Q.height,ft,Tt,Q.data)):e.texImage2D(n.TEXTURE_2D,0,Rt,Q.width,Q.height,0,ft,Tt,Q.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Lt&&re&&e.texStorage3D(n.TEXTURE_2D_ARRAY,at,Rt,Ht[0].width,Ht[0].height,Q.depth);for(let V=0,K=Ht.length;V<K;V++)if(pt=Ht[V],_.format!==fn)if(ft!==null)if(Lt){if(P)if(_.layerUpdates.size>0){const lt=cu(pt.width,pt.height,_.format,_.type);for(const ct of _.layerUpdates){const It=pt.data.subarray(ct*lt/pt.data.BYTES_PER_ELEMENT,(ct+1)*lt/pt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,V,0,0,ct,pt.width,pt.height,1,ft,It)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,V,0,0,0,pt.width,pt.height,Q.depth,ft,pt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,V,Rt,pt.width,pt.height,Q.depth,0,pt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?P&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,V,0,0,0,pt.width,pt.height,Q.depth,ft,Tt,pt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,V,Rt,pt.width,pt.height,Q.depth,0,ft,Tt,pt.data)}else{Lt&&re&&e.texStorage2D(n.TEXTURE_2D,at,Rt,Ht[0].width,Ht[0].height);for(let V=0,K=Ht.length;V<K;V++)pt=Ht[V],_.format!==fn?ft!==null?Lt?P&&e.compressedTexSubImage2D(n.TEXTURE_2D,V,0,0,pt.width,pt.height,ft,pt.data):e.compressedTexImage2D(n.TEXTURE_2D,V,Rt,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?P&&e.texSubImage2D(n.TEXTURE_2D,V,0,0,pt.width,pt.height,ft,Tt,pt.data):e.texImage2D(n.TEXTURE_2D,V,Rt,pt.width,pt.height,0,ft,Tt,pt.data)}else if(_.isDataArrayTexture)if(Lt){if(re&&e.texStorage3D(n.TEXTURE_2D_ARRAY,at,Rt,Q.width,Q.height,Q.depth),P)if(_.layerUpdates.size>0){const V=cu(Q.width,Q.height,_.format,_.type);for(const K of _.layerUpdates){const lt=Q.data.subarray(K*V/Q.data.BYTES_PER_ELEMENT,(K+1)*V/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,K,Q.width,Q.height,1,ft,Tt,lt)}_.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ft,Tt,Q.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Rt,Q.width,Q.height,Q.depth,0,ft,Tt,Q.data);else if(_.isData3DTexture)Lt?(re&&e.texStorage3D(n.TEXTURE_3D,at,Rt,Q.width,Q.height,Q.depth),P&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ft,Tt,Q.data)):e.texImage3D(n.TEXTURE_3D,0,Rt,Q.width,Q.height,Q.depth,0,ft,Tt,Q.data);else if(_.isFramebufferTexture){if(re)if(Lt)e.texStorage2D(n.TEXTURE_2D,at,Rt,Q.width,Q.height);else{let V=Q.width,K=Q.height;for(let lt=0;lt<at;lt++)e.texImage2D(n.TEXTURE_2D,lt,Rt,V,K,0,ft,Tt,null),V>>=1,K>>=1}}else if(Ht.length>0){if(Lt&&re){const V=vt(Ht[0]);e.texStorage2D(n.TEXTURE_2D,at,Rt,V.width,V.height)}for(let V=0,K=Ht.length;V<K;V++)pt=Ht[V],Lt?P&&e.texSubImage2D(n.TEXTURE_2D,V,0,0,ft,Tt,pt):e.texImage2D(n.TEXTURE_2D,V,Rt,ft,Tt,pt);_.generateMipmaps=!1}else if(Lt){if(re){const V=vt(Q);e.texStorage2D(n.TEXTURE_2D,at,Rt,V.width,V.height)}P&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ft,Tt,Q)}else e.texImage2D(n.TEXTURE_2D,0,Rt,ft,Tt,Q);m(_)&&f(j),_t.__version=$.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function tt(M,_,B){if(_.image.length!==6)return;const j=ie(M,_),Z=_.source;e.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+B);const $=i.get(Z);if(Z.version!==$.__version||j===!0){e.activeTexture(n.TEXTURE0+B);const _t=Yt.getPrimaries(Yt.workingColorSpace),ot=_.colorSpace===ni?null:Yt.getPrimaries(_.colorSpace),ht=_.colorSpace===ni||_t===ot?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ht);const Gt=_.isCompressedTexture||_.image[0].isCompressedTexture,Q=_.image[0]&&_.image[0].isDataTexture,ft=[];for(let K=0;K<6;K++)!Gt&&!Q?ft[K]=v(_.image[K],!0,r.maxCubemapSize):ft[K]=Q?_.image[K].image:_.image[K],ft[K]=se(_,ft[K]);const Tt=ft[0],Rt=s.convert(_.format,_.colorSpace),pt=s.convert(_.type),Ht=b(_.internalFormat,Rt,pt,_.colorSpace),Lt=_.isVideoTexture!==!0,re=$.__version===void 0||j===!0,P=Z.dataReady;let at=I(_,Tt);Ot(n.TEXTURE_CUBE_MAP,_);let V;if(Gt){Lt&&re&&e.texStorage2D(n.TEXTURE_CUBE_MAP,at,Ht,Tt.width,Tt.height);for(let K=0;K<6;K++){V=ft[K].mipmaps;for(let lt=0;lt<V.length;lt++){const ct=V[lt];_.format!==fn?Rt!==null?Lt?P&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,0,0,ct.width,ct.height,Rt,ct.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,Ht,ct.width,ct.height,0,ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Lt?P&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,0,0,ct.width,ct.height,Rt,pt,ct.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt,Ht,ct.width,ct.height,0,Rt,pt,ct.data)}}}else{if(V=_.mipmaps,Lt&&re){V.length>0&&at++;const K=vt(ft[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,at,Ht,K.width,K.height)}for(let K=0;K<6;K++)if(Q){Lt?P&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ft[K].width,ft[K].height,Rt,pt,ft[K].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ht,ft[K].width,ft[K].height,0,Rt,pt,ft[K].data);for(let lt=0;lt<V.length;lt++){const It=V[lt].image[K].image;Lt?P&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,0,0,It.width,It.height,Rt,pt,It.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,Ht,It.width,It.height,0,Rt,pt,It.data)}}else{Lt?P&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Rt,pt,ft[K]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ht,Rt,pt,ft[K]);for(let lt=0;lt<V.length;lt++){const ct=V[lt];Lt?P&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,0,0,Rt,pt,ct.image[K]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,lt+1,Ht,Rt,pt,ct.image[K])}}}m(_)&&f(n.TEXTURE_CUBE_MAP),$.__version=Z.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function gt(M,_,B,j,Z,$){const _t=s.convert(B.format,B.colorSpace),ot=s.convert(B.type),ht=b(B.internalFormat,_t,ot,B.colorSpace),Gt=i.get(_),Q=i.get(B);if(Q.__renderTarget=_,!Gt.__hasExternalTextures){const ft=Math.max(1,_.width>>$),Tt=Math.max(1,_.height>>$);Z===n.TEXTURE_3D||Z===n.TEXTURE_2D_ARRAY?e.texImage3D(Z,$,ht,ft,Tt,_.depth,0,_t,ot,null):e.texImage2D(Z,$,ht,ft,Tt,0,_t,ot,null)}e.bindFramebuffer(n.FRAMEBUFFER,M),zt(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,Z,Q.__webglTexture,0,Vt(_)):(Z===n.TEXTURE_2D||Z>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,j,Z,Q.__webglTexture,$),e.bindFramebuffer(n.FRAMEBUFFER,null)}function st(M,_,B){if(n.bindRenderbuffer(n.RENDERBUFFER,M),_.depthBuffer){const j=_.depthTexture,Z=j&&j.isDepthTexture?j.type:null,$=y(_.stencilBuffer,Z),_t=_.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ot=Vt(_);zt(_)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ot,$,_.width,_.height):B?n.renderbufferStorageMultisample(n.RENDERBUFFER,ot,$,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,$,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,_t,n.RENDERBUFFER,M)}else{const j=_.textures;for(let Z=0;Z<j.length;Z++){const $=j[Z],_t=s.convert($.format,$.colorSpace),ot=s.convert($.type),ht=b($.internalFormat,_t,ot,$.colorSpace),Gt=Vt(_);B&&zt(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Gt,ht,_.width,_.height):zt(_)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Gt,ht,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,ht,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function bt(M,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,M),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=i.get(_.depthTexture);j.__renderTarget=_,(!j.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X(_.depthTexture,0);const Z=j.__webglTexture,$=Vt(_);if(_.depthTexture.format===jr)zt(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0);else if(_.depthTexture.format===Kr)zt(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function jt(M){const _=i.get(M),B=M.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==M.depthTexture){const j=M.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),j){const Z=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,j.removeEventListener("dispose",Z)};j.addEventListener("dispose",Z),_.__depthDisposeCallback=Z}_.__boundDepthTexture=j}if(M.depthTexture&&!_.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");bt(_.__webglFramebuffer,M)}else if(B){_.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(e.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[j]),_.__webglDepthbuffer[j]===void 0)_.__webglDepthbuffer[j]=n.createRenderbuffer(),st(_.__webglDepthbuffer[j],M,!1);else{const Z=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,$=_.__webglDepthbuffer[j];n.bindRenderbuffer(n.RENDERBUFFER,$),n.framebufferRenderbuffer(n.FRAMEBUFFER,Z,n.RENDERBUFFER,$)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=n.createRenderbuffer(),st(_.__webglDepthbuffer,M,!1);else{const j=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Z=_.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,Z),n.framebufferRenderbuffer(n.FRAMEBUFFER,j,n.RENDERBUFFER,Z)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function At(M,_,B){const j=i.get(M);_!==void 0&&gt(j.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),B!==void 0&&jt(M)}function fe(M){const _=M.texture,B=i.get(M),j=i.get(_);M.addEventListener("dispose",R);const Z=M.textures,$=M.isWebGLCubeRenderTarget===!0,_t=Z.length>1;if(_t||(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=_.version,o.memory.textures++),$){B.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer[ot]=[];for(let ht=0;ht<_.mipmaps.length;ht++)B.__webglFramebuffer[ot][ht]=n.createFramebuffer()}else B.__webglFramebuffer[ot]=n.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer=[];for(let ot=0;ot<_.mipmaps.length;ot++)B.__webglFramebuffer[ot]=n.createFramebuffer()}else B.__webglFramebuffer=n.createFramebuffer();if(_t)for(let ot=0,ht=Z.length;ot<ht;ot++){const Gt=i.get(Z[ot]);Gt.__webglTexture===void 0&&(Gt.__webglTexture=n.createTexture(),o.memory.textures++)}if(M.samples>0&&zt(M)===!1){B.__webglMultisampledFramebuffer=n.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let ot=0;ot<Z.length;ot++){const ht=Z[ot];B.__webglColorRenderbuffer[ot]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,B.__webglColorRenderbuffer[ot]);const Gt=s.convert(ht.format,ht.colorSpace),Q=s.convert(ht.type),ft=b(ht.internalFormat,Gt,Q,ht.colorSpace,M.isXRRenderTarget===!0),Tt=Vt(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Tt,ft,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ot,n.RENDERBUFFER,B.__webglColorRenderbuffer[ot])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(B.__webglDepthRenderbuffer=n.createRenderbuffer(),st(B.__webglDepthRenderbuffer,M,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if($){e.bindTexture(n.TEXTURE_CUBE_MAP,j.__webglTexture),Ot(n.TEXTURE_CUBE_MAP,_);for(let ot=0;ot<6;ot++)if(_.mipmaps&&_.mipmaps.length>0)for(let ht=0;ht<_.mipmaps.length;ht++)gt(B.__webglFramebuffer[ot][ht],M,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ht);else gt(B.__webglFramebuffer[ot],M,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);m(_)&&f(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(_t){for(let ot=0,ht=Z.length;ot<ht;ot++){const Gt=Z[ot],Q=i.get(Gt);e.bindTexture(n.TEXTURE_2D,Q.__webglTexture),Ot(n.TEXTURE_2D,Gt),gt(B.__webglFramebuffer,M,Gt,n.COLOR_ATTACHMENT0+ot,n.TEXTURE_2D,0),m(Gt)&&f(n.TEXTURE_2D)}e.unbindTexture()}else{let ot=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(ot=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(ot,j.__webglTexture),Ot(ot,_),_.mipmaps&&_.mipmaps.length>0)for(let ht=0;ht<_.mipmaps.length;ht++)gt(B.__webglFramebuffer[ht],M,_,n.COLOR_ATTACHMENT0,ot,ht);else gt(B.__webglFramebuffer,M,_,n.COLOR_ATTACHMENT0,ot,0);m(_)&&f(ot),e.unbindTexture()}M.depthBuffer&&jt(M)}function ce(M){const _=M.textures;for(let B=0,j=_.length;B<j;B++){const Z=_[B];if(m(Z)){const $=T(M),_t=i.get(Z).__webglTexture;e.bindTexture($,_t),f($),e.unbindTexture()}}}const kt=[],C=[];function je(M){if(M.samples>0){if(zt(M)===!1){const _=M.textures,B=M.width,j=M.height;let Z=n.COLOR_BUFFER_BIT;const $=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,_t=i.get(M),ot=_.length>1;if(ot)for(let ht=0;ht<_.length;ht++)e.bindFramebuffer(n.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,_t.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,_t.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,_t.__webglFramebuffer);for(let ht=0;ht<_.length;ht++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(Z|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(Z|=n.STENCIL_BUFFER_BIT)),ot){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,_t.__webglColorRenderbuffer[ht]);const Gt=i.get(_[ht]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Gt,0)}n.blitFramebuffer(0,0,B,j,0,0,B,j,Z,n.NEAREST),c===!0&&(kt.length=0,C.length=0,kt.push(n.COLOR_ATTACHMENT0+ht),M.depthBuffer&&M.resolveDepthBuffer===!1&&(kt.push($),C.push($),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,C)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,kt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ot)for(let ht=0;ht<_.length;ht++){e.bindFramebuffer(n.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.RENDERBUFFER,_t.__webglColorRenderbuffer[ht]);const Gt=i.get(_[ht]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,_t.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ht,n.TEXTURE_2D,Gt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,_t.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&c){const _=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[_])}}}function Vt(M){return Math.min(r.maxSamples,M.samples)}function zt(M){const _=i.get(M);return M.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function xt(M){const _=o.render.frame;u.get(M)!==_&&(u.set(M,_),M.update())}function se(M,_){const B=M.colorSpace,j=M.format,Z=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||B!==xr&&B!==ni&&(Yt.getTransfer(B)===te?(j!==fn||Z!==Gn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),_}function vt(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(l.width=M.naturalWidth||M.width,l.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(l.width=M.displayWidth,l.height=M.displayHeight):(l.width=M.width,l.height=M.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=N,this.setTexture2D=X,this.setTexture2DArray=G,this.setTexture3D=q,this.setTextureCube=H,this.rebindTextures=At,this.setupRenderTarget=fe,this.updateRenderTargetMipmap=ce,this.updateMultisampleRenderTarget=je,this.setupDepthRenderbuffer=jt,this.setupFrameBufferTexture=gt,this.useMultisampledRTT=zt}function cS(n,t){function e(i,r=ni){let s;const o=Yt.getTransfer(r);if(i===Gn)return n.UNSIGNED_BYTE;if(i===$c)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Yc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Hd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===kd)return n.BYTE;if(i===zd)return n.SHORT;if(i===Yr)return n.UNSIGNED_SHORT;if(i===Xc)return n.INT;if(i===Di)return n.UNSIGNED_INT;if(i===Fn)return n.FLOAT;if(i===zn)return n.HALF_FLOAT;if(i===Vd)return n.ALPHA;if(i===Gd)return n.RGB;if(i===fn)return n.RGBA;if(i===Wd)return n.LUMINANCE;if(i===Xd)return n.LUMINANCE_ALPHA;if(i===jr)return n.DEPTH_COMPONENT;if(i===Kr)return n.DEPTH_STENCIL;if(i===$d)return n.RED;if(i===qc)return n.RED_INTEGER;if(i===Yd)return n.RG;if(i===jc)return n.RG_INTEGER;if(i===Kc)return n.RGBA_INTEGER;if(i===Js||i===Qs||i===to||i===eo)if(o===te)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Js)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Qs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===to)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===eo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Js)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Qs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===to)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===eo)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ya||i===qa||i===ja||i===Ka)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Ya)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===qa)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ja)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ka)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Za||i===Ja||i===Qa)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Za||i===Ja)return o===te?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Qa)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===tc||i===ec||i===nc||i===ic||i===rc||i===sc||i===oc||i===ac||i===cc||i===lc||i===uc||i===dc||i===hc||i===fc)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===tc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ec)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===nc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ic)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===rc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===sc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===oc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ac)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===cc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===lc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===uc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===dc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===hc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===fc)return o===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===no||i===pc||i===mc)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===no)return o===te?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===pc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===mc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===qd||i===gc||i===_c||i===vc)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===no)return s.COMPRESSED_RED_RGTC1_EXT;if(i===gc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===_c)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===vc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===qr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const lS=`
void main() {
...
}`;class dS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const r=new Ne,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new Ue({vertexShader:lS,fragmentShader:uS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new He(new Ao(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hS extends Hi{constructor(t,e){super();const i=this;let r=null,s=1,o=null,a="local-floor",c=1,l=null,u=null,d=null,h=null,p=null,g=null;const v=new dS,m=e.getContextAttributes();let f=null,T=null;const b=[],y=[],I=new yt;let w=null;const R=new tn;R.viewport=new de;const U=new tn;U.viewport=new de;const E=[R,U],x=new Im;let A=null,N=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let tt=b[Y];return tt===void 0&&(tt=new sa,b[Y]=tt),tt.getTargetRaySpace()},this.getControllerGrip=function(Y){let tt=b[Y];return tt===void 0&&(tt=new sa,b[Y]=tt),tt.getGripSpace()},this.getHand=function(Y){let tt=b[Y];return tt===void 0&&(tt=new sa,b[Y]=tt),tt.getHandSpace()};function O(Y){const tt=y.indexOf(Y.inputSource);if(tt===-1)return;const gt=b[tt];gt!==void 0&&(gt.update(Y.inputSource,Y.frame,l||o),gt.dispatchEvent({type:Y.type,data:Y.inputSource}))}function W(){r.removeEventListener("select",O),r.removeEventListener("selectstart",O),r.removeEventListener("selectend",O),r.removeEventListener("squeeze",O),r.removeEventListener("squeezestart",O),r.removeEventListener("squeezeend",O),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",X);for(let Y=0;Y<b.length;Y++){const tt=y[Y];tt!==null&&(y[Y]=null,b[Y].disconnect(tt))}A=null,N=null,v.reset(),t.setRenderTarget(f),p=null,h=null,d=null,r=null,T=null,ie.stop(),i.isPresenting=!1,t.setPixelRatio(w),t.setSize(I.width,I.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){a=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(Y){l=Y},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return d},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(f=t.getRenderTarget(),r.addEventListener("select",O),r.addEventListener("selectstart",O),r.addEventListener("selectend",O),r.addEventListener("squeeze",O),r.addEventListener("squeezestart",O),r.addEventListener("squeezeend",O),r.addEventListener("end",W),r.addEventListener("inputsourceschange",X),m.xrCompatible!==!0&&await e.makeXRCompatible(),w=t.getPixelRatio(),t.getSize(I),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let gt=null,st=null,bt=null;m.depth&&(bt=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,gt=m.stencil?Kr:jr,st=m.stencil?qr:Di);const jt={colorFormat:e.RGBA8,depthFormat:bt,scaleFactor:s};d=new XRWebGLBinding(r,e),h=d.createProjectionLayer(jt),r.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),T=new mn(h.textureWidth,h.textureHeight,{format:fn,type:Gn,depthTexture:new ah(h.textureWidth,h.textureHeight,st,void 0,void 0,void 0,void 0,void 0,void 0,gt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const gt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,e,gt),r.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new mn(p.framebufferWidth,p.framebufferHeight,{format:fn,type:Gn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await r.requestReferenceSpace(a),ie.setContext(r),ie.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function X(Y){for(let tt=0;tt<Y.removed.length;tt++){const gt=Y.removed[tt],st=y.indexOf(gt);st>=0&&(y[st]=null,b[st].disconnect(gt))}for(let tt=0;tt<Y.added.length;tt++){const gt=Y.added[tt];let st=y.indexOf(gt);if(st===-1){for(let jt=0;jt<b.length;jt++)if(jt>=y.length){y.push(gt),st=jt;break}else if(y[jt]===null){y[jt]=gt,st=jt;break}if(st===-1)break}const bt=b[st];bt&&bt.connect(gt)}}const G=new F,q=new F;function H(Y,tt,gt){G.setFromMatrixPosition(tt.matrixWorld),q.setFromMatrixPosition(gt.matrixWorld);const st=G.distanceTo(q),bt=tt.projectionMatrix.elements,jt=gt.projectionMatrix.elements,At=bt[14]/(bt[10]-1),fe=bt[14]/(bt[10]+1),ce=(bt[9]+1)/bt[5],kt=(bt[9]-1)/bt[5],C=(bt[8]-1)/bt[0],je=(jt[8]+1)/jt[0],Vt=At*C,zt=At*je,xt=st/(-C+je),se=xt*-C;if(tt.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(se),Y.translateZ(xt),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),bt[10]===-1)Y.projectionMatrix.copy(tt.projectionMatrix),Y.projectionMatrixInverse.copy(tt.projectionMatrixInverse);else{const vt=At+xt,M=fe+xt,_=Vt-se,B=zt+(st-se),j=ce*fe/M*vt,Z=kt*fe/M*vt;Y.projectionMatrix.makePerspective(_,B,j,Z,vt,M),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function et(Y,tt){tt===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(tt.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let tt=Y.near,gt=Y.far;v.texture!==null&&(v.depthNear>0&&(tt=v.depthNear),v.depthFar>0&&(gt=v.depthFar)),x.near=U.near=R.near=tt,x.far=U.far=R.far=gt,(A!==x.near||N!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),A=x.near,N=x.far),R.layers.mask=Y.layers.mask|2,U.layers.mask=Y.layers.mask|4,x.layers.mask=R.layers.mask|U.layers.mask;const st=Y.parent,bt=x.cameras;et(x,st);for(let jt=0;jt<bt.length;jt++)et(bt[jt],st);bt.length===2?H(x,R,U):x.projectionMatrix.copy(R.projectionMatrix),dt(Y,x,st)};function dt(Y,tt,gt){gt===null?Y.matrix.copy(tt.matrixWorld):(Y.matrix.copy(gt.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(tt.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(tt.projectionMatrix),Y.projectionMatrixInverse.copy(tt.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Zr*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(h===null&&p===null))return c},this.setFoveation=function(Y){c=Y,h!==null&&(h.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(x)};let St=null;function Ot(Y,tt){if(u=tt.getViewerPose(l||o),g=tt,u!==null){const gt=u.views;p!==null&&(t.setRenderTargetFramebuffer(T,p.framebuffer),t.setRenderTarget(T));let st=!1;gt.length!==x.cameras.length&&(x.cameras.length=0,st=!0);for(let At=0;At<gt.length;At++){const fe=gt[At];let ce=null;if(p!==null)ce=p.getViewport(fe);else{const C=d.getViewSubImage(h,fe);ce=C.viewport,At===0&&(t.setRenderTargetTextures(T,C.colorTexture,C.depthStencilTexture),t.setRenderTarget(T))}let kt=E[At];kt===void 0&&(kt=new tn,kt.layers.enable(At),kt.viewport=new de,E[At]=kt),kt.matrix.fromArray(fe.transform.matrix),kt.matrix.decompose(kt.position,kt.quaternion,kt.scale),kt.projectionMatrix.fromArray(fe.projectionMatrix),kt.projectionMatrixInverse.copy(kt.projectionMatrix).invert(),kt.viewport.set(ce.x,ce.y,ce.width,ce.height),At===0&&(x.matrix.copy(kt.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),st===!0&&x.cameras.push(kt)}const bt=r.enabledFeatures;if(bt&&bt.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&d){const At=d.getDepthInformation(gt[0]);At&&At.isValid&&At.texture&&v.init(t,At,r.renderState)}}for(let gt=0;gt<b.length;gt++){const st=y[gt],bt=b[gt];st!==null&&bt!==void 0&&bt.update(st,tt,l||o)}St&&St(Y,tt),tt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:tt}),g=null}const ie=new lh;ie.setAnimationLoop(Ot),this.setAnimationLoop=function(Y){St=Y},this.dispose=function(){}}}const xi=new bn,fS=new he;function pS(n,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,rh(n)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,T,b,y){f.isMeshBasicMaterial||f.isMeshLambertMaterial?s(m,f):f.isMeshToonMaterial?(s(m,f),d(m,f)):f.isMeshPhongMaterial?(s(m,f),u(m,f)):f.isMeshStandardMaterial?(s(m,f),h(m,f),f.isMeshPhysicalMaterial&&p(m,f,y)):f.isMeshMatcapMaterial?(s(m,f),g(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),v(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(o(m,f),f.isLineDashedMaterial&&a(m,f)):f.isPointsMaterial?c(m,f,T,b):f.isSpriteMaterial?l(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Ve&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Ve&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const T=t.get(f),b=T.envMap,y=T.envMapRotation;b&&(m.envMap.value=b,xi.copy(y),xi.x*=-1,xi.y*=-1,xi.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(xi.y*=-1,xi.z*=-1),m.envMapRotation.value.setFromMatrix4(fS.makeRotationFromEuler(xi)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function o(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function a(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function c(m,f,T,b){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*T,m.scale.value=b*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function l(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function d(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function h(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,T){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ve&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){const T=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function mS(n,t,e,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function c(T,b){const y=b.program;i.uniformBlockBinding(T,y)}function l(T,b){let y=r[T.id];y===void 0&&(g(T),y=u(T),r[T.id]=y,T.addEventListener("dispose",m));const I=b.program;i.updateUBOMapping(T,I);const w=t.render.frame;s[T.id]!==w&&(h(T),s[T.id]=w)}function u(T){const b=d();T.__bindingPointIndex=b;const y=n.createBuffer(),I=T.__size,w=T.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,I,w),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,y),y}function d(){for(let T=0;T<a;T++)if(o.indexOf(T)===-1)return o.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(T){const b=r[T.id],y=T.uniforms,I=T.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let w=0,R=y.length;w<R;w++){const U=Array.isArray(y[w])?y[w]:[y[w]];for(let E=0,x=U.length;E<x;E++){const A=U[E];if(p(A,w,E,I)===!0){const N=A.__offset,O=Array.isArray(A.value)?A.value:[A.value];let W=0;for(let X=0;X<O.length;X++){const G=O[X],q=v(G);typeof G=="number"||typeof G=="boolean"?(A.__data[0]=G,n.bufferSubData(n.UNIFORM_BUFFER,N+W,A.__data)):G.isMatrix3?(A.__data[0]=G.elements[0],A.__data[1]=G.elements[1],A.__data[2]=G.elements[2],A.__data[3]=0,A.__data[4]=G.elements[3],A.__data[5]=G.elements[4],A.__data[6]=G.elements[5],A.__data[7]=0,A.__data[8]=G.elements[6],A.__data[9]=G.elements[7],A.__data[10]=G.elements[8],A.__data[11]=0):(G.toArray(A.__data,W),W+=q.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,N,A.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(T,b,y,I){const w=T.value,R=b+"_"+y;if(I[R]===void 0)return typeof w=="number"||typeof w=="boolean"?I[R]=w:I[R]=w.clone(),!0;{const U=I[R];if(typeof w=="number"||typeof w=="boolean"){if(U!==w)return I[R]=w,!0}else if(U.equals(w)===!1)return U.copy(w),!0}return!1}function g(T){const b=T.uniforms;let y=0;const I=16;for(let R=0,U=b.length;R<U;R++){const E=Array.isArray(b[R])?b[R]:[b[R]];for(let x=0,A=E.length;x<A;x++){const N=E[x],O=Array.isArray(N.value)?N.value:[N.value];for(let W=0,X=O.length;W<X;W++){const G=O[W],q=v(G),H=y%I,et=H%q.boundary,dt=H+et;y+=et,dt!==0&&I-dt<q.storage&&(y+=I-dt),N.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=y,y+=q.storage}}}const w=y%I;return w>0&&(y+=I-w),T.__size=y,T.__cache={},this}function v(T){const b={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(b.boundary=4,b.storage=4):T.isVector2?(b.boundary=8,b.storage=8):T.isVector3||T.isColor?(b.boundary=16,b.storage=12):T.isVector4?(b.boundary=16,b.storage=16):T.isMatrix3?(b.boundary=48,b.storage=48):T.isMatrix4?(b.boundary=64,b.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),b}function m(T){const b=T.target;b.removeEventListener("dispose",m);const y=o.indexOf(b.__bindingPointIndex);o.splice(y,1),n.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function f(){for(const T in r)n.deleteBuffer(r[T]);o=[],r={},s={}}return{bind:c,update:l,dispose:f}}class gS{constructor(t={}){const{canvas:e=Xp(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:h=!1}=t;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const g=new Uint32Array(4),v=new Int32Array(4);let m=null,f=null;const T=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ii,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let I=!1;this._outputColorSpace=Qe;let w=0,R=0,U=null,E=-1,x=null;const A=new de,N=new de;let O=null;const W=new Bt(0);let X=0,G=e.width,q=e.height,H=1,et=null,dt=null;const St=new de(0,0,G,q),Ot=new de(0,0,G,q);let ie=!1;const Y=new el;let tt=!1,gt=!1;const st=new he,bt=new he,jt=new F,At=new de,fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ce=!1;function kt(){return U===null?H:1}let C=i;function je(S,D){return e.getContext(S,D)}try{const S={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Wc}`),e.addEventListener("webglcontextlost",K,!1),e.addEventListener("webglcontextrestored",lt,!1),e.addEventListener("webglcontextcreationerror",ct,!1),C===null){const D="webgl2";if(C=je(D,S),C===null)throw je(D)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let Vt,zt,xt,se,vt,M,_,B,j,Z,$,_t,ot,ht,Gt,Q,ft,Tt,Rt,pt,Ht,Lt,re,P;function at(){Vt=new Av(C),Vt.init(),Lt=new cS(C,Vt),zt=new Sv(C,Vt,t,Lt),xt=new oS(C,Vt),zt.reverseDepthBuffer&&h&&xt.buffers.depth.setReversed(!0),se=new Cv(C),vt=new Y0,M=new aS(C,Vt,xt,vt,zt,Lt,se),_=new Ev(y),B=new Tv(y),j=new Nm(C),re=new _v(C,j),Z=new wv(C,j,se,re),$=new Iv(C,Z,j,se),Rt=new Pv(C,zt,M),Q=new xv(vt),_t=new $0(y,_,B,Vt,zt,re,Q),ot=new pS(y,vt),ht=new j0,Gt=new eS(Vt),Tt=new gv(y,_,B,xt,$,p,c),ft=new rS(y,$,zt),P=new mS(C,se,zt,xt),pt=new vv(C,Vt,se),Ht=new Rv(C,Vt,se),se.programs=_t.programs,y.capabilities=zt,y.extensions=Vt,y.properties=vt,y.renderLists=ht,y.shadowMap=ft,y.state=xt,y.info=se}at();const V=new hS(y,C);this.xr=V,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const S=Vt.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=Vt.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return H},this.setPixelRatio=function(S){S!==void 0&&(H=S,this.setSize(G,q,!1))},this.getSize=function(S){return S.set(G,q)},this.setSize=function(S,D,k=!0){if(V.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=S,q=D,e.width=Math.floor(S*H),e.height=Math.floor(D*H),k===!0&&(e.style.width=S+"px",e.style.height=D+"px"),this.setViewport(0,0,S,D)},this.getDrawingBufferSize=function(S){return S.set(G*H,q*H).floor()},this.setDrawingBufferSize=function(S,D,k){G=S,q=D,H=k,e.width=Math.floor(S*k),e.height=Math.floor(D*k),this.setViewport(0,0,S,D)},this.getCurrentViewport=function(S){return S.copy(A)},this.getViewport=function(S){return S.copy(St)},this.setViewport=function(S,D,k,z){S.isVector4?St.set(S.x,S.y,S.z,S.w):St.set(S,D,k,z),xt.viewport(A.copy(St).multiplyScalar(H).round())},this.getScissor=function(S){return S.copy(Ot)},this.setScissor=function(S,D,k,z){S.isVector4?Ot.set(S.x,S.y,S.z,S.w):Ot.set(S,D,k,z),xt.scissor(N.copy(Ot).multiplyScalar(H).round())},this.getScissorTest=function(){return ie},this.setScissorTest=function(S){xt.setScissorTest(ie=S)},this.setOpaqueSort=function(S){et=S},this.setTransparentSort=function(S){dt=S},this.getClearColor=function(S){return S.copy(Tt.getClearColor())},this.setClearColor=function(){Tt.setClearColor(...arguments)},this.getClearAlpha=function(){return Tt.getClearAlpha()},this.setClearAlpha=function(){Tt.setClearAlpha(...arguments)},this.clear=function(S=!0,D=!0,k=!0){let z=0;if(S){let L=!1;if(U!==null){const J=U.texture.format;L=J===Kc||J===jc||J===qc}if(L){const J=U.texture.type,rt=J===Gn||J===Di||J===Yr||J===qr||J===$c||J===Yc,ut=Tt.getClearColor(),mt=Tt.getClearAlpha(),Ct=ut.r,wt=ut.g,Et=ut.b;rt?(g[0]=Ct,g[1]=wt,g[2]=Et,g[3]=mt,C.clearBufferuiv(C.COLOR,0,g)):(v[0]=Ct,v[1]=wt,v[2]=Et,v[3]=mt,C.clearBufferiv(C.COLOR,0,v))}else z|=C.COLOR_BUFFER_BIT}D&&(z|=C.DEPTH_BUFFER_BIT),k&&(z|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),C.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",K,!1),e.removeEventListener("webglcontextrestored",lt,!1),e.removeEventListener("webglcontextcreationerror",ct,!1),Tt.dispose(),ht.dispose(),Gt.dispose(),vt.dispose(),_.dispose(),B.dispose(),$.dispose(),re.dispose(),P.dispose(),_t.dispose(),V.dispose(),V.removeEventListener("sessionstart",Al),V.removeEventListener("sessionend",wl),fi.stop()};function K(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function lt(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const S=se.autoReset,D=ft.enabled,k=ft.autoUpdate,z=ft.needsUpdate,L=ft.type;at(),se.autoReset=S,ft.enabled=D,ft.autoUpdate=k,ft.needsUpdate=z,ft.type=L}function ct(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function It(S){const D=S.target;D.removeEventListener("dispose",It),le(D)}function le(S){Ae(S),vt.remove(S)}function Ae(S){const D=vt.get(S).programs;D!==void 0&&(D.forEach(function(k){_t.releaseProgram(k)}),S.isShaderMaterial&&_t.releaseShaderCache(S))}this.renderBufferDirect=function(S,D,k,z,L,J){D===null&&(D=fe);const rt=L.isMesh&&L.matrixWorld.determinant()<0,ut=Ff(S,D,k,z,L);xt.setMaterial(z,rt);let mt=k.index,Ct=1;if(z.wireframe===!0){if(mt=Z.getWireframeAttribute(k),mt===void 0)return;Ct=2}const wt=k.drawRange,Et=k.attributes.position;let Wt=wt.start*Ct,Kt=(wt.start+wt.count)*Ct;J!==null&&(Wt=Math.max(Wt,J.start*Ct),Kt=Math.min(Kt,(J.start+J.count)*Ct)),mt!==null?(Wt=Math.max(Wt,0),Kt=Math.min(Kt,mt.count)):Et!=null&&(Wt=Math.max(Wt,0),Kt=Math.min(Kt,Et.count));const me=Kt-Wt;if(me<0||me===1/0)return;re.setup(L,z,ut,k,mt);let ue,$t=pt;if(mt!==null&&(ue=j.get(mt),$t=Ht,$t.setIndex(ue)),L.isMesh)z.wireframe===!0?(xt.setLineWidth(z.wireframeLinewidth*kt()),$t.setMode(C.LINES)):$t.setMode(C.TRIANGLES);else if(L.isLine){let Mt=z.linewidth;Mt===void 0&&(Mt=1),xt.setLineWidth(Mt*kt()),L.isLineSegments?$t.setMode(C.LINES):L.isLineLoop?$t.setMode(C.LINE_LOOP):$t.setMode(C.LINE_STRIP)}else L.isPoints?$t.setMode(C.POINTS):L.isSprite&&$t.setMode(C.TRIANGLES);if(L.isBatchedMesh)if(L._multiDrawInstances!==null)io("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),$t.renderMultiDrawInstances(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount,L._multiDrawInstances);else if(Vt.get("WEBGL_multi_draw"))$t.renderMultiDraw(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount);else{const Mt=L._multiDrawStarts,Me=L._multiDrawCounts,Zt=L._multiDrawCount,cn=mt?j.get(mt).bytesPerElement:1,Yi=vt.get(z).currentProgram.getUniforms();for(let Ge=0;Ge<Zt;Ge++)Yi.setValue(C,"_gl_DrawID",Ge),$t.render(Mt[Ge]/cn,Me[Ge])}else if(L.isInstancedMesh)$t.renderInstances(Wt,me,L.count);else if(k.isInstancedBufferGeometry){const Mt=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,Me=Math.min(k.instanceCount,Mt);$t.renderInstances(Wt,me,Me)}else $t.render(Wt,me)};function Jt(S,D,k){S.transparent===!0&&S.side===Nn&&S.forceSinglePass===!1?(S.side=Ve,S.needsUpdate=!0,Ss(S,D,k),S.side=si,S.needsUpdate=!0,Ss(S,D,k),S.side=Nn):Ss(S,D,k)}this.compile=function(S,D,k=null){k===null&&(k=S),f=Gt.get(k),f.init(D),b.push(f),k.traverseVisible(function(L){L.isLight&&L.layers.test(D.layers)&&(f.pushLight(L),L.castShadow&&f.pushShadow(L))}),S!==k&&S.traverseVisible(function(L){L.isLight&&L.layers.test(D.layers)&&(f.pushLight(L),L.castShadow&&f.pushShadow(L))}),f.setupLights();const z=new Set;return S.traverse(function(L){if(!(L.isMesh||L.isPoints||L.isLine||L.isSprite))return;const J=L.material;if(J)if(Array.isArray(J))for(let rt=0;rt<J.length;rt++){const ut=J[rt];Jt(ut,k,L),z.add(ut)}else Jt(J,k,L),z.add(J)}),f=b.pop(),z},this.compileAsync=function(S,D,k=null){const z=this.compile(S,D,k);return new Promise(L=>{function J(){if(z.forEach(function(rt){vt.get(rt).currentProgram.isReady()&&z.delete(rt)}),z.size===0){L(S);return}setTimeout(J,10)}Vt.get("KHR_parallel_shader_compile")!==null?J():setTimeout(J,10)})};let an=null;function Tn(S){an&&an(S)}function Al(){fi.stop()}function wl(){fi.start()}const fi=new lh;fi.setAnimationLoop(Tn),typeof self<"u"&&fi.setContext(self),this.setAnimationLoop=function(S){an=S,V.setAnimationLoop(S),S===null?fi.stop():fi.start()},V.addEventListener("sessionstart",Al),V.addEventListener("sessionend",wl),this.render=function(S,D){if(D!==void 0&&D.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),V.enabled===!0&&V.isPresenting===!0&&(V.cameraAutoUpdate===!0&&V.updateCamera(D),D=V.getCamera()),S.isScene===!0&&S.onBeforeRender(y,S,D,U),f=Gt.get(S,b.length),f.init(D),b.push(f),bt.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),Y.setFromProjectionMatrix(bt),gt=this.localClippingEnabled,tt=Q.init(this.clippingPlanes,gt),m=ht.get(S,T.length),m.init(),T.push(m),V.enabled===!0&&V.isPresenting===!0){const J=y.xr.getDepthSensingMesh();J!==null&&Oo(J,D,-1/0,y.sortObjects)}Oo(S,D,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(et,dt),ce=V.enabled===!1||V.isPresenting===!1||V.hasDepthSensing()===!1,ce&&Tt.addToRenderList(m,S),this.info.render.frame++,tt===!0&&Q.beginShadows();const k=f.state.shadowsArray;ft.render(k,S,D),tt===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const z=m.opaque,L=m.transmissive;if(f.setupLights(),D.isArrayCamera){const J=D.cameras;if(L.length>0)for(let rt=0,ut=J.length;rt<ut;rt++){const mt=J[rt];Cl(z,L,S,mt)}ce&&Tt.render(S);for(let rt=0,ut=J.length;rt<ut;rt++){const mt=J[rt];Rl(m,S,mt,mt.viewport)}}else L.length>0&&Cl(z,L,S,D),ce&&Tt.render(S),Rl(m,S,D);U!==null&&R===0&&(M.updateMultisampleRenderTarget(U),M.updateRenderTargetMipmap(U)),S.isScene===!0&&S.onAfterRender(y,S,D),re.resetDefaultState(),E=-1,x=null,b.pop(),b.length>0?(f=b[b.length-1],tt===!0&&Q.setGlobalState(y.clippingPlanes,f.state.camera)):f=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function Oo(S,D,k,z){if(S.visible===!1)return;if(S.layers.test(D.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(D);else if(S.isLight)f.pushLight(S),S.castShadow&&f.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||Y.intersectsSprite(S)){z&&At.setFromMatrixPosition(S.matrixWorld).applyMatrix4(bt);const rt=$.update(S),ut=S.material;ut.visible&&m.push(S,rt,ut,k,At.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||Y.intersectsObject(S))){const rt=$.update(S),ut=S.material;if(z&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),At.copy(S.boundingSphere.center)):(rt.boundingSphere===null&&rt.computeBoundingSphere(),At.copy(rt.boundingSphere.center)),At.applyMatrix4(S.matrixWorld).applyMatrix4(bt)),Array.isArray(ut)){const mt=rt.groups;for(let Ct=0,wt=mt.length;Ct<wt;Ct++){const Et=mt[Ct],Wt=ut[Et.materialIndex];Wt&&Wt.visible&&m.push(S,rt,Wt,k,At.z,Et)}}else ut.visible&&m.push(S,rt,ut,k,At.z,null)}}const J=S.children;for(let rt=0,ut=J.length;rt<ut;rt++)Oo(J[rt],D,k,z)}function Rl(S,D,k,z){const L=S.opaque,J=S.transmissive,rt=S.transparent;f.setupLightsView(k),tt===!0&&Q.setGlobalState(y.clippingPlanes,k),z&&xt.viewport(A.copy(z)),L.length>0&&vs(L,D,k),J.length>0&&vs(J,D,k),rt.length>0&&vs(rt,D,k),xt.buffers.depth.setTest(!0),xt.buffers.depth.setMask(!0),xt.buffers.color.setMask(!0),xt.setPolygonOffset(!1)}function Cl(S,D,k,z){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[z.id]===void 0&&(f.state.transmissionRenderTarget[z.id]=new mn(1,1,{generateMipmaps:!0,type:Vt.has("EXT_color_buffer_half_float")||Vt.has("EXT_color_buffer_float")?zn:Gn,minFilter:Ai,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Yt.workingColorSpace}));const J=f.state.transmissionRenderTarget[z.id],rt=z.viewport||A;J.setSize(rt.z*y.transmissionResolutionScale,rt.w*y.transmissionResolutionScale);const ut=y.getRenderTarget();y.setRenderTarget(J),y.getClearColor(W),X=y.getClearAlpha(),X<1&&y.setClearColor(16777215,.5),y.clear(),ce&&Tt.render(k);const mt=y.toneMapping;y.toneMapping=ii;const Ct=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),f.setupLightsView(z),tt===!0&&Q.setGlobalState(y.clippingPlanes,z),vs(S,k,z),M.updateMultisampleRenderTarget(J),M.updateRenderTargetMipmap(J),Vt.has("WEBGL_multisampled_render_to_texture")===!1){let wt=!1;for(let Et=0,Wt=D.length;Et<Wt;Et++){const Kt=D[Et],me=Kt.object,ue=Kt.geometry,$t=Kt.material,Mt=Kt.group;if($t.side===Nn&&me.layers.test(z.layers)){const Me=$t.side;$t.side=Ve,$t.needsUpdate=!0,Pl(me,k,z,ue,$t,Mt),$t.side=Me,$t.needsUpdate=!0,wt=!0}}wt===!0&&(M.updateMultisampleRenderTarget(J),M.updateRenderTargetMipmap(J))}y.setRenderTarget(ut),y.setClearColor(W,X),Ct!==void 0&&(z.viewport=Ct),y.toneMapping=mt}function vs(S,D,k){const z=D.isScene===!0?D.overrideMaterial:null;for(let L=0,J=S.length;L<J;L++){const rt=S[L],ut=rt.object,mt=rt.geometry,Ct=rt.group;let wt=rt.material;wt.allowOverride===!0&&z!==null&&(wt=z),ut.layers.test(k.layers)&&Pl(ut,D,k,mt,wt,Ct)}}function Pl(S,D,k,z,L,J){S.onBeforeRender(y,D,k,z,L,J),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),L.onBeforeRender(y,D,k,z,S,J),L.transparent===!0&&L.side===Nn&&L.forceSinglePass===!1?(L.side=Ve,L.needsUpdate=!0,y.renderBufferDirect(k,D,z,L,S,J),L.side=si,L.needsUpdate=!0,y.renderBufferDirect(k,D,z,L,S,J),L.side=Nn):y.renderBufferDirect(k,D,z,L,S,J),S.onAfterRender(y,D,k,z,L,J)}function Ss(S,D,k){D.isScene!==!0&&(D=fe);const z=vt.get(S),L=f.state.lights,J=f.state.shadowsArray,rt=L.state.version,ut=_t.getParameters(S,L.state,J,D,k),mt=_t.getProgramCacheKey(ut);let Ct=z.programs;z.environment=S.isMeshStandardMaterial?D.environment:null,z.fog=D.fog,z.envMap=(S.isMeshStandardMaterial?B:_).get(S.envMap||z.environment),z.envMapRotation=z.environment!==null&&S.envMap===null?D.environmentRotation:S.envMapRotation,Ct===void 0&&(S.addEventListener("dispose",It),Ct=new Map,z.programs=Ct);let wt=Ct.get(mt);if(wt!==void 0){if(z.currentProgram===wt&&z.lightsStateVersion===rt)return Dl(S,ut),wt}else ut.uniforms=_t.getUniforms(S),S.onBeforeCompile(ut,y),wt=_t.acquireProgram(ut,mt),Ct.set(mt,wt),z.uniforms=ut.uniforms;const Et=z.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Et.clippingPlanes=Q.uniform),Dl(S,ut),z.needsLights=Bf(S),z.lightsStateVersion=rt,z.needsLights&&(Et.ambientLightColor.value=L.state.ambient,Et.lightProbe.value=L.state.probe,Et.directionalLights.value=L.state.directional,Et.directionalLightShadows.value=L.state.directionalShadow,Et.spotLights.value=L.state.spot,Et.spotLightShadows.value=L.state.spotShadow,Et.rectAreaLights.value=L.state.rectArea,Et.ltc_1.value=L.state.rectAreaLTC1,Et.ltc_2.value=L.state.rectAreaLTC2,Et.pointLights.value=L.state.point,Et.pointLightShadows.value=L.state.pointShadow,Et.hemisphereLights.value=L.state.hemi,Et.directionalShadowMap.value=L.state.directionalShadowMap,Et.directionalShadowMatrix.value=L.state.directionalShadowMatrix,Et.spotShadowMap.value=L.state.spotShadowMap,Et.spotLightMatrix.value=L.state.spotLightMatrix,Et.spotLightMap.value=L.state.spotLightMap,Et.pointShadowMap.value=L.state.pointShadowMap,Et.pointShadowMatrix.value=L.state.pointShadowMatrix),z.currentProgram=wt,z.uniformsList=null,wt}function Il(S){if(S.uniformsList===null){const D=S.currentProgram.getUniforms();S.uniformsList=ro.seqWithValue(D.seq,S.uniforms)}return S.uniformsList}function Dl(S,D){const k=vt.get(S);k.outputColorSpace=D.outputColorSpace,k.batching=D.batching,k.batchingColor=D.batchingColor,k.instancing=D.instancing,k.instancingColor=D.instancingColor,k.instancingMorph=D.instancingMorph,k.skinning=D.skinning,k.morphTargets=D.morphTargets,k.morphNormals=D.morphNormals,k.morphColors=D.morphColors,k.morphTargetsCount=D.morphTargetsCount,k.numClippingPlanes=D.numClippingPlanes,k.numIntersection=D.numClipIntersection,k.vertexAlphas=D.vertexAlphas,k.vertexTangents=D.vertexTangents,k.toneMapping=D.toneMapping}function Ff(S,D,k,z,L){D.isScene!==!0&&(D=fe),M.resetTextureUnits();const J=D.fog,rt=z.isMeshStandardMaterial?D.environment:null,ut=U===null?y.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:xr,mt=(z.isMeshStandardMaterial?B:_).get(z.envMap||rt),Ct=z.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,wt=!!k.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),Et=!!k.morphAttributes.position,Wt=!!k.morphAttributes.normal,Kt=!!k.morphAttributes.color;let me=ii;z.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(me=y.toneMapping);const ue=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,$t=ue!==void 0?ue.length:0,Mt=vt.get(z),Me=f.state.lights;if(tt===!0&&(gt===!0||S!==x)){const Ie=S===x&&z.id===E;Q.setState(z,S,Ie)}let Zt=!1;z.version===Mt.__version?(Mt.needsLights&&Mt.lightsStateVersion!==Me.state.version||Mt.outputColorSpace!==ut||L.isBatchedMesh&&Mt.batching===!1||!L.isBatchedMesh&&Mt.batching===!0||L.isBatchedMesh&&Mt.batchingColor===!0&&L.colorTexture===null||L.isBatchedMesh&&Mt.batchingColor===!1&&L.colorTexture!==null||L.isInstancedMesh&&Mt.instancing===!1||!L.isInstancedMesh&&Mt.instancing===!0||L.isSkinnedMesh&&Mt.skinning===!1||!L.isSkinnedMesh&&Mt.skinning===!0||L.isInstancedMesh&&Mt.instancingColor===!0&&L.instanceColor===null||L.isInstancedMesh&&Mt.instancingColor===!1&&L.instanceColor!==null||L.isInstancedMesh&&Mt.instancingMorph===!0&&L.morphTexture===null||L.isInstancedMesh&&Mt.instancingMorph===!1&&L.morphTexture!==null||Mt.envMap!==mt||z.fog===!0&&Mt.fog!==J||Mt.numClippingPlanes!==void 0&&(Mt.numClippingPlanes!==Q.numPlanes||Mt.numIntersection!==Q.numIntersection)||Mt.vertexAlphas!==Ct||Mt.vertexTangents!==wt||Mt.morphTargets!==Et||Mt.morphNormals!==Wt||Mt.morphColors!==Kt||Mt.toneMapping!==me||Mt.morphTargetsCount!==$t)&&(Zt=!0):(Zt=!0,Mt.__version=z.version);let cn=Mt.currentProgram;Zt===!0&&(cn=Ss(z,D,L));let Yi=!1,Ge=!1,Fr=!1;const oe=cn.getUniforms(),Ke=Mt.uniforms;if(xt.useProgram(cn.program)&&(Yi=!0,Ge=!0,Fr=!0),z.id!==E&&(E=z.id,Ge=!0),Yi||x!==S){xt.buffers.depth.getReversed()?(st.copy(S.projectionMatrix),Yp(st),qp(st),oe.setValue(C,"projectionMatrix",st)):oe.setValue(C,"projectionMatrix",S.projectionMatrix),oe.setValue(C,"viewMatrix",S.matrixWorldInverse);const Be=oe.map.cameraPosition;Be!==void 0&&Be.setValue(C,jt.setFromMatrixPosition(S.matrixWorld)),zt.logarithmicDepthBuffer&&oe.setValue(C,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&oe.setValue(C,"isOrthographic",S.isOrthographicCamera===!0),x!==S&&(x=S,Ge=!0,Fr=!0)}if(L.isSkinnedMesh){oe.setOptional(C,L,"bindMatrix"),oe.setOptional(C,L,"bindMatrixInverse");const Ie=L.skeleton;Ie&&(Ie.boneTexture===null&&Ie.computeBoneTexture(),oe.setValue(C,"boneTexture",Ie.boneTexture,M))}L.isBatchedMesh&&(oe.setOptional(C,L,"batchingTexture"),oe.setValue(C,"batchingTexture",L._matricesTexture,M),oe.setOptional(C,L,"batchingIdTexture"),oe.setValue(C,"batchingIdTexture",L._indirectTexture,M),oe.setOptional(C,L,"batchingColorTexture"),L._colorsTexture!==null&&oe.setValue(C,"batchingColorTexture",L._colorsTexture,M));const Ze=k.morphAttributes;if((Ze.position!==void 0||Ze.normal!==void 0||Ze.color!==void 0)&&Rt.update(L,k,cn),(Ge||Mt.receiveShadow!==L.receiveShadow)&&(Mt.receiveShadow=L.receiveShadow,oe.setValue(C,"receiveShadow",L.receiveShadow)),z.isMeshGouraudMaterial&&z.envMap!==null&&(Ke.envMap.value=mt,Ke.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),z.isMeshStandardMaterial&&z.envMap===null&&D.environment!==null&&(Ke.envMapIntensity.value=D.environmentIntensity),Ge&&(oe.setValue(C,"toneMappingExposure",y.toneMappingExposure),Mt.needsLights&&Of(Ke,Fr),J&&z.fog===!0&&ot.refreshFogUniforms(Ke,J),ot.refreshMaterialUniforms(Ke,z,H,q,f.state.transmissionRenderTarget[S.id]),ro.upload(C,Il(Mt),Ke,M)),z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(ro.upload(C,Il(Mt),Ke,M),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&oe.setValue(C,"center",L.center),oe.setValue(C,"modelViewMatrix",L.modelViewMatrix),oe.setValue(C,"normalMatrix",L.normalMatrix),oe.setValue(C,"modelMatrix",L.matrixWorld),z.isShaderMaterial||z.isRawShaderMaterial){const Ie=z.uniformsGroups;for(let Be=0,Bo=Ie.length;Be<Bo;Be++){const pi=Ie[Be];P.update(pi,cn),P.bind(pi,cn)}}return cn}function Of(S,D){S.ambientLightColor.needsUpdate=D,S.lightProbe.needsUpdate=D,S.directionalLights.needsUpdate=D,S.directionalLightShadows.needsUpdate=D,S.pointLights.needsUpdate=D,S.pointLightShadows.needsUpdate=D,S.spotLights.needsUpdate=D,S.spotLightShadows.needsUpdate=D,S.rectAreaLights.needsUpdate=D,S.hemisphereLights.needsUpdate=D}function Bf(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(S,D,k){const z=vt.get(S);z.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),vt.get(S.texture).__webglTexture=D,vt.get(S.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:k,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,D){const k=vt.get(S);k.__webglFramebuffer=D,k.__useDefaultFramebuffer=D===void 0};const kf=C.createFramebuffer();this.setRenderTarget=function(S,D=0,k=0){U=S,w=D,R=k;let z=!0,L=null,J=!1,rt=!1;if(S){const mt=vt.get(S);if(mt.__useDefaultFramebuffer!==void 0)xt.bindFramebuffer(C.FRAMEBUFFER,null),z=!1;else if(mt.__webglFramebuffer===void 0)M.setupRenderTarget(S);else if(mt.__hasExternalTextures)M.rebindTextures(S,vt.get(S.texture).__webglTexture,vt.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const Et=S.depthTexture;if(mt.__boundDepthTexture!==Et){if(Et!==null&&vt.has(Et)&&(S.width!==Et.image.width||S.height!==Et.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");M.setupDepthRenderbuffer(S)}}const Ct=S.texture;(Ct.isData3DTexture||Ct.isDataArrayTexture||Ct.isCompressedArrayTexture)&&(rt=!0);const wt=vt.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(wt[D])?L=wt[D][k]:L=wt[D],J=!0):S.samples>0&&M.useMultisampledRTT(S)===!1?L=vt.get(S).__webglMultisampledFramebuffer:Array.isArray(wt)?L=wt[k]:L=wt,A.copy(S.viewport),N.copy(S.scissor),O=S.scissorTest}else A.copy(St).multiplyScalar(H).floor(),N.copy(Ot).multiplyScalar(H).floor(),O=ie;if(k!==0&&(L=kf),xt.bindFramebuffer(C.FRAMEBUFFER,L)&&z&&xt.drawBuffers(S,L),xt.viewport(A),xt.scissor(N),xt.setScissorTest(O),J){const mt=vt.get(S.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+D,mt.__webglTexture,k)}else if(rt){const mt=vt.get(S.texture),Ct=D;C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,mt.__webglTexture,k,Ct)}else if(S!==null&&k!==0){const mt=vt.get(S.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,mt.__webglTexture,k)}E=-1},this.readRenderTargetPixels=function(S,D,k,z,L,J,rt){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ut=vt.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&rt!==void 0&&(ut=ut[rt]),ut){xt.bindFramebuffer(C.FRAMEBUFFER,ut);try{const mt=S.texture,Ct=mt.format,wt=mt.type;if(!zt.textureFormatReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!zt.textureTypeReadable(wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=S.width-z&&k>=0&&k<=S.height-L&&C.readPixels(D,k,z,L,Lt.convert(Ct),Lt.convert(wt),J)}finally{const mt=U!==null?vt.get(U).__webglFramebuffer:null;xt.bindFramebuffer(C.FRAMEBUFFER,mt)}}},this.readRenderTargetPixelsAsync=async function(S,D,k,z,L,J,rt){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ut=vt.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&rt!==void 0&&(ut=ut[rt]),ut)if(D>=0&&D<=S.width-z&&k>=0&&k<=S.height-L){xt.bindFramebuffer(C.FRAMEBUFFER,ut);const mt=S.texture,Ct=mt.format,wt=mt.type;if(!zt.textureFormatReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!zt.textureTypeReadable(wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Et=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Et),C.bufferData(C.PIXEL_PACK_BUFFER,J.byteLength,C.STREAM_READ),C.readPixels(D,k,z,L,Lt.convert(Ct),Lt.convert(wt),0);const Wt=U!==null?vt.get(U).__webglFramebuffer:null;xt.bindFramebuffer(C.FRAMEBUFFER,Wt);const Kt=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await $p(C,Kt,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Et),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,J),C.deleteBuffer(Et),C.deleteSync(Kt),J}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,D=null,k=0){const z=Math.pow(2,-k),L=Math.floor(S.image.width*z),J=Math.floor(S.image.height*z),rt=D!==null?D.x:0,ut=D!==null?D.y:0;M.setTexture2D(S,0),C.copyTexSubImage2D(C.TEXTURE_2D,k,0,0,rt,ut,L,J),xt.unbindTexture()};const zf=C.createFramebuffer(),Hf=C.createFramebuffer();this.copyTextureToTexture=function(S,D,k=null,z=null,L=0,J=null){J===null&&(L!==0?(io("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),J=L,L=0):J=0);let rt,ut,mt,Ct,wt,Et,Wt,Kt,me;const ue=S.isCompressedTexture?S.mipmaps[J]:S.image;if(k!==null)rt=k.max.x-k.min.x,ut=k.max.y-k.min.y,mt=k.isBox3?k.max.z-k.min.z:1,Ct=k.min.x,wt=k.min.y,Et=k.isBox3?k.min.z:0;else{const Ze=Math.pow(2,-L);rt=Math.floor(ue.width*Ze),ut=Math.floor(ue.height*Ze),S.isDataArrayTexture?mt=ue.depth:S.isData3DTexture?mt=Math.floor(ue.depth*Ze):mt=1,Ct=0,wt=0,Et=0}z!==null?(Wt=z.x,Kt=z.y,me=z.z):(Wt=0,Kt=0,me=0);const $t=Lt.convert(D.format),Mt=Lt.convert(D.type);let Me;D.isData3DTexture?(M.setTexture3D(D,0),Me=C.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(M.setTexture2DArray(D,0),Me=C.TEXTURE_2D_ARRAY):(M.setTexture2D(D,0),Me=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,D.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,D.unpackAlignment);const Zt=C.getParameter(C.UNPACK_ROW_LENGTH),cn=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Yi=C.getParameter(C.UNPACK_SKIP_PIXELS),Ge=C.getParameter(C.UNPACK_SKIP_ROWS),Fr=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,ue.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ue.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Ct),C.pixelStorei(C.UNPACK_SKIP_ROWS,wt),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Et);const oe=S.isDataArrayTexture||S.isData3DTexture,Ke=D.isDataArrayTexture||D.isData3DTexture;if(S.isDepthTexture){const Ze=vt.get(S),Ie=vt.get(D),Be=vt.get(Ze.__renderTarget),Bo=vt.get(Ie.__renderTarget);xt.bindFramebuffer(C.READ_FRAMEBUFFER,Be.__webglFramebuffer),xt.bindFramebuffer(C.DRAW_FRAMEBUFFER,Bo.__webglFramebuffer);for(let pi=0;pi<mt;pi++)oe&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,vt.get(S).__webglTexture,L,Et+pi),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,vt.get(D).__webglTexture,J,me+pi)),C.blitFramebuffer(Ct,wt,rt,ut,Wt,Kt,rt,ut,C.DEPTH_BUFFER_BIT,C.NEAREST);xt.bindFramebuffer(C.READ_FRAMEBUFFER,null),xt.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(L!==0||S.isRenderTargetTexture||vt.has(S)){const Ze=vt.get(S),Ie=vt.get(D);xt.bindFramebuffer(C.READ_FRAMEBUFFER,zf),xt.bindFramebuffer(C.DRAW_FRAMEBUFFER,Hf);for(let Be=0;Be<mt;Be++)oe?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Ze.__webglTexture,L,Et+Be):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Ze.__webglTexture,L),Ke?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Ie.__webglTexture,J,me+Be):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Ie.__webglTexture,J),L!==0?C.blitFramebuffer(Ct,wt,rt,ut,Wt,Kt,rt,ut,C.COLOR_BUFFER_BIT,C.NEAREST):Ke?C.copyTexSubImage3D(Me,J,Wt,Kt,me+Be,Ct,wt,rt,ut):C.copyTexSubImage2D(Me,J,Wt,Kt,Ct,wt,rt,ut);xt.bindFramebuffer(C.READ_FRAMEBUFFER,null),xt.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else Ke?S.isDataTexture||S.isData3DTexture?C.texSubImage3D(Me,J,Wt,Kt,me,rt,ut,mt,$t,Mt,ue.data):D.isCompressedArrayTexture?C.compressedTexSubImage3D(Me,J,Wt,Kt,me,rt,ut,mt,$t,ue.data):C.texSubImage3D(Me,J,Wt,Kt,me,rt,ut,mt,$t,Mt,ue):S.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,J,Wt,Kt,rt,ut,$t,Mt,ue.data):S.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,J,Wt,Kt,ue.width,ue.height,$t,ue.data):C.texSubImage2D(C.TEXTURE_2D,J,Wt,Kt,rt,ut,$t,Mt,ue);C.pixelStorei(C.UNPACK_ROW_LENGTH,Zt),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,cn),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Yi),C.pixelStorei(C.UNPACK_SKIP_ROWS,Ge),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Fr),J===0&&D.generateMipmaps&&C.generateMipmap(Me),xt.unbindTexture()},this.copyTextureToTexture3D=function(S,D,k=null,z=null,L=0){return io('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(S,D,k,z,L)},this.initRenderTarget=function(S){vt.get(S).__webglFramebuffer===void 0&&M.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?M.setTextureCube(S,0):S.isData3DTexture?M.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?M.setTexture2DArray(S,0):M.setTexture2D(S,0),xt.unbindTexture()},this.resetState=function(){w=0,R=0,U=null,xt.reset(),re.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return On}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=Yt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Yt._getUnpackColorSpace()}}const Lu={type:"change"},ol={type:"start"},ph={type:"end"},Vs=new Qd,Uu=new ei,_S=Math.cos(70*Sc.DEG2RAD),_e=new F,ke=2*Math.PI,ee={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},ma=1e-6;class vS extends Lm{constructor(t,e=null){super(t,e),this.state=ee.NONE,this.target=new F,this.cursor=new F,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:pr.ROTATE,MIDDLE:pr.DOLLY,RIGHT:pr.PAN},this.touches={ONE:ur.ROTATE,TWO:ur.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new F,this._lastQuaternion=new Li,this._lastTargetPosition=new F,this._quat=new Li().setFromUnitVectors(t.up,new F(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new au,this._sphericalDelta=new au,this._scale=1,this._panOffset=new F,this._rotateStart=new yt,this._rotateEnd=new yt,this._rotateDelta=new yt,this._panStart=new yt,this._panEnd=new yt,this._panDelta=new yt,this._dollyStart=new yt,this._dollyEnd=new yt,this._dollyDelta=new yt,this._dollyDirection=new F,this._mouse=new yt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=xS.bind(this),this._onPointerDown=SS.bind(this),this._onPointerUp=ES.bind(this),this._onContextMenu=RS.bind(this),this._onMouseWheel=bS.bind(this),this._onKeyDown=TS.bind(this),this._onTouchStart=AS.bind(this),this._onTouchMove=wS.bind(this),this._onMouseDown=yS.bind(this),this._onMouseMove=MS.bind(this),this._interceptControlDown=CS.bind(this),this._interceptControlUp=PS.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Lu),this.update(),this.state=ee.NONE}update(t=null){const e=this.object.position;_e.copy(e).sub(this.target),_e.applyQuaternion(this._quat),this._spherical.setFromVector3(_e),this.autoRotate&&this.state===ee.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(i)&&isFinite(r)&&(i<-Math.PI?i+=ke:i>Math.PI&&(i-=ke),r<-Math.PI?r+=ke:r>Math.PI&&(r-=ke),i<=r?this._spherical.theta=Math.max(i,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+r)/2?Math.max(i,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=o!=this._spherical.radius}if(_e.setFromSpherical(this._spherical),_e.applyQuaternion(this._quatInverse),e.copy(this.target).add(_e),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=_e.length();o=this._clampDistance(a*this._scale);const c=a-o;this.object.position.addScaledVector(this._dollyDirection,c),this.object.updateMatrixWorld(),s=!!c}else if(this.object.isOrthographicCamera){const a=new F(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const c=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=c!==this.object.zoom;const l=new F(this._mouse.x,this._mouse.y,0);l.unproject(this.object),this.object.position.sub(l).add(a),this.object.updateMatrixWorld(),o=_e.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(Vs.origin.copy(this.object.position),Vs.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Vs.direction))<_S?this.object.lookAt(this.target):(Uu.setFromNormalAndCoplanarPoint(this.object.up,this.target),Vs.intersectPlane(Uu,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>ma||8*(1-this._lastQuaternion.dot(this.object.quaternion))>ma||this._lastTargetPosition.distanceToSquared(this.target)>ma?(this.dispatchEvent(Lu),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?ke/60*this.autoRotateSpeed*t:ke/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){_e.setFromMatrixColumn(e,0),_e.multiplyScalar(-t),this._panOffset.add(_e)}_panUp(t,e){this.screenSpacePanning===!0?_e.setFromMatrixColumn(e,1):(_e.setFromMatrixColumn(e,0),_e.crossVectors(this.object.up,_e)),_e.multiplyScalar(t),this._panOffset.add(_e)}_pan(t,e){const i=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;_e.copy(r).sub(this.target);let s=_e.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*s/i.clientHeight,this.object.matrix),this._panUp(2*e*s/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),r=t-i.left,s=e-i.top,o=i.width,a=i.height;this._mouse.x=r/o*2-1,this._mouse.y=-(s/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(ke*this._rotateDelta.x/e.clientHeight),this._rotateUp(ke*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._rotateStart.set(i,r)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panStart.set(i,r)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),r=.5*(t.pageX+i.x),s=.5*(t.pageY+i.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(ke*this._rotateDelta.x/e.clientHeight),this._rotateUp(ke*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panEnd.set(i,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(t.pageX+e.x)*.5,a=(t.pageY+e.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new yt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,i={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function SS(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function xS(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function ES(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(ph),this.state=ee.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function yS(n){let t;switch(n.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case pr.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=ee.DOLLY;break;case pr.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=ee.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=ee.ROTATE}break;case pr.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=ee.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=ee.PAN}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(ol)}function MS(n){switch(this.state){case ee.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case ee.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case ee.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function bS(n){this.enabled===!1||this.enableZoom===!1||this.state!==ee.NONE||(n.preventDefault(),this.dispatchEvent(ol),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(ph))}function TS(n){this.enabled!==!1&&this._handleKeyDown(n)}function AS(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case ur.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=ee.TOUCH_ROTATE;break;case ur.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=ee.TOUCH_PAN;break;default:this.state=ee.NONE}break;case 2:switch(this.touches.TWO){case ur.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=ee.TOUCH_DOLLY_PAN;break;case ur.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=ee.TOUCH_DOLLY_ROTATE;break;default:this.state=ee.NONE}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(ol)}function wS(n){switch(this._trackPointer(n),this.state){case ee.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case ee.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case ee.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case ee.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=ee.NONE}}function RS(n){this.enabled!==!1&&n.preventDefault()}function CS(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function PS(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}/**
 * lil-gui
...
Error:`,r)}}function ZM(){return CM(n=>{Nr("cls",{metric:n}),Sf=n},{reportAllChanges:!0})}function JM(){return IM(n=>{Nr("fid",{metric:n}),xf=n})}function QM(){return WM(n=>{Nr("lcp",{metric:n}),Ef=n},{reportAllChanges:!0})}function tb(){return $M(n=>{Nr("ttfb",{metric:n}),yf=n})}function eb(){return VM(n=>{Nr("inp",{metric:n}),Mf=n})}function _s(n,t,e,i,r=!1){Tf(n,t);let s;return bo[n]||(s=e(),bo[n]=!0),i&&t({metric:i}),Af(n,t,r?s:void 0)}function nb(n){const t={};n==="event"&&(t.durationThreshold=0),$i(n,e=>{Nr(n,{entries:e})},t)}function Tf(n,t){$r[n]=$r[n]||[],$r[n].push(t)}function Af(n,t,e){return()=>{e&&e();const i=$r[n];if(!i)return;const r=i.indexOf(t);r!==-1&&i.splice(r,1)}}function ib(n){return"duration"in n}function wa(n){return typeof n=="number"&&isFinite(n)}function Yn(n,t,e,{...i}){const r=ne(n).start_timestamp;return r&&r>t&&typeof n.updateStartTime=="function"&&n.updateStartTime(t),qh(n,()=>{const s=fs({startTime:t,...i});return s&&s.end(e),s})}function wf(n){var m;const t=Qt();if(!t)return;const{name:e,transaction:i,attributes:r,startTime:s}=n,{release:o,environment:a,sendDefaultPii:c}=t.getOptions(),l=t.getIntegrationByName("Replay"),u=l==null?void 0:l.getReplayId(),d=ae(),h=d.getUser(),p=h!==void 0?h.email||h.id||h.ip_address:void 0;let g;try{g=d.getScopeData().contexts.profile.profile_id}catch{}const v={release:o,environment:a,user:p||void 0,profile_id:g||void 0,replay_id:u||void 0,transaction:i,"user_agent.original":(m=Ft.navigator)==null?void 0:m.userAgent,"client.address":c?"{{auto}}":void 0,...r};return fs({name:e,attributes:v,startTime:s,experimental:{standalone:!0}})}function bl(){return Ft.addEventListener&&Ft.performance}function pe(n){return n/1e3}function Rf(n){let t="unknown",e="unknown",i="";for(const r of n){if(r==="/"){[t,e]=n.split("/");break}if(!isNaN(Number(r))){t=i==="h"?"http":i,e=n.split(i)[1];break}i+=r}return i===n&&(t=i),{name:t,version:e}}function rb(){let n=0,t,e;if(!ob())return;let i=!1;function r(){i||(i=!0,e&&sb(n,t,e),s())}const s=bf(({metric:o})=>{const a=o.entries[o.entries.length-1];a&&(n=o.value,t=a)},!0);Ur(()=>{r()}),setTimeout(()=>{const o=Qt();if(!o)return;const a=o.on("startNavigationSpan",()=>{r(),a==null||a()}),c=qe();if(c){const l=Oe(c);ne(l).op==="pageload"&&(e=l.spanContext().spanId)}},0)}function sb(n,t,e){var c;Ml&&it.log(`Sending CLS span (${n})`);const i=pe((on()||0)+((t==null?void 0:t.startTime)||0)),r=ae().getScopeData().transactionName,s=t?Ni((c=t.sources[0])==null?void 0:c.node):"Layout shift",o={[ye]:"auto.http.browser.cls",[Fi]:"ui.webvital.cls",[ds]:(t==null?void 0:t.duration)||0,"sentry.pageload.span_id":e},a=wf({name:s,transaction:r,attributes:o,startTime:i});a&&(a.addEvent("cls",{[Do]:"",[Lo]:n}),a.end(i))}function ob(){try{return PerformanceObserver.supportedEntryTypes.includes("layout-shift")}catch{return!1}}const ab=2147483647;let Md=0,Te={},ze,hr;function cb({recordClsStandaloneSpans:n}){const t=bl();if(t&&on()){t.mark&&Ft.performance.mark("sentry-tracing-init");const e=pb(),i=fb(),r=mb(),s=n?rb():hb();return()=>{e(),i(),r(),s==null||s()}}return()=>{}}function lb(){rs("longtask",({entries:n})=>{const t=qe();if(!t)return;const{op:e,start_timestamp:i}=ne(t);for(const r of n){const s=pe(on()+r.startTime),o=pe(r.duration);e==="navigation"&&i&&s<i||Yn(t,s,s+o,{name:"Main UI thread blocked",op:"ui.long-task",attributes:{[ye]:"auto.ui.browser.metrics"}})}})}function ub(){new PerformanceObserver(t=>{const e=qe();if(e)for(const i of t.getEntries()){if(!i.scripts[0])continue;const r=pe(on()+i.startTime),{start_timestamp:s,op:o}=ne(e);if(o==="navigation"&&s&&r<s)continue;const a=pe(i.duration),c={[ye]:"auto.ui.browser.metrics"},l=i.scripts[0],{invoker:u,invokerType:d,sourceURL:h,sourceFunctionName:p,sourceCharPosition:g}=l;c["browser.script.invoker"]=u,c["browser.script.invoker_type"]=d,h&&(c["code.filepath"]=h),p&&(c["code.function"]=p),g!==-1&&(c["browser.script.source_char_position"]=g),Yn(e,r,r+a,{name:"Main UI thread blocked",op:"ui.long-animation-frame",attributes:c})}}).observe({type:"long-animation-frame",buffered:!0})}function db(){rs("event",({entries:n})=>{const t=qe();if(t){for(const e of n)if(e.name==="click"){const i=pe(on()+e.startTime),r=pe(e.duration),s={name:Ni(e.target),op:`ui.interaction.${e.name}`,startTime:i,attributes:{[ye]:"auto.ui.browser.metrics"}},o=xh(e.target);o&&(s.attributes["ui.component_name"]=o),Yn(t,i,i+r,s)}}})}function hb(){return bf(({metric:n})=>{const t=n.entries[n.entries.length-1];t&&(Te.cls={value:n.value,unit:""},hr=t)},!0)}function fb(){return YM(({metric:n})=>{const t=n.entries[n.entries.length-1];t&&(Te.lcp={value:n.value,unit:"millisecond"},ze=t)},!0)}function pb(){return qM(({metric:n})=>{const t=n.entries[n.entries.length-1];if(!t)return;const e=pe(on()),i=pe(t.startTime);Te.fid={value:n.value,unit:"millisecond"},Te["mark.fid"]={value:e+i,unit:"second"}})}function mb(){return jM(({metric:n})=>{n.entries[n.entries.length-1]&&(Te.ttfb={value:n.value,unit:"millisecond"})})}function gb(n,t){const e=bl(),i=on();if(!(e!=null&&e.getEntries)||!i)return;const r=pe(i),s=e.getEntries(),{op:o,start_timestamp:a}=ne(n);if(s.slice(Md).forEach(c=>{const l=pe(c.startTime),u=pe(Math.max(0,c.duration));if(!(o==="navigation"&&a&&r+l<a))switch(c.entryType){case"navigation":{vb(n,c,r);break}case"mark":case"paint":case"measure":{_b(n,c,l,u,r);const d=No(),h=c.startTime<d.firstHiddenTime;c.name==="first-paint"&&h&&(Te.fp={value:c.startTime,unit:"millisecond"}),c.name==="first-contentful-paint"&&h&&(Te.fcp={value:c.startTime,unit:"millisecond"});break}case"resource":{Eb(n,c,c.name,l,u,r);break}}}),Md=Math.max(s.length-1,0),yb(n),o==="pageload"){bb(Te);const c=Te["mark.fid"];c&&Te.fid&&(Yn(n,c.value,c.value+pe(Te.fid.value),{name:"first input delay",op:"ui.action",attributes:{[ye]:"auto.ui.browser.metrics"}}),delete Te["mark.fid"]),(!("fcp"in Te)||!t.recordClsOnPageloadSpan)&&delete Te.cls,Object.entries(Te).forEach(([l,u])=>{fE(l,u.value,u.unit)}),n.setAttribute("performance.timeOrigin",r),n.setAttribute("performance.activationStart",ms()),Mb(n)}ze=void 0,hr=void 0,Te={}}function _b(n,t,e,i,r){const s=ps(!1),o=pe(s?s.requestStart:0),a=r+Math.max(e,o),c=r+e,l=c+i,u={[ye]:"auto.resource.browser.metrics"};a!==c&&(u["sentry.browser.measure_happened_before_request"]=!0,u["sentry.browser.measure_start_time"]=a),a<=l&&Yn(n,a,l,{name:t.name,op:t.entryType,attributes:u})}function vb(n,t,e){["unloadEvent","redirect","domContentLoadedEvent","loadEvent","connect"].forEach(i=>{js(n,t,i,e)}),js(n,t,"secureConnection",e,"TLS/SSL"),js(n,t,"fetch",e,"cache"),js(n,t,"domainLookup",e,"DNS"),xb(n,t,e)}function js(n,t,e,i,r=e){const s=Sb(e),o=t[s],a=t[`${e}Start`];!a||!o||Yn(n,i+pe(a),i+pe(o),{op:`browser.${r}`,name:t.name,attributes:{[ye]:"auto.ui.browser.metrics",...e==="redirect"&&t.redirectCount!=null?{"http.redirect_count":t.redirectCount}:{}}})}function Sb(n){return n==="secureConnection"?"connectEnd":n==="fetch"?"domainLookupStart":`${n}End`}function xb(n,t,e){const i=e+pe(t.requestStart),r=e+pe(t.responseEnd),s=e+pe(t.responseStart);t.responseEnd&&(Yn(n,i,r,{op:"browser.request",name:t.name,attributes:{[ye]:"auto.ui.browser.metrics"}}),Yn(n,s,r,{op:"browser.response",name:t.name,attributes:{[ye]:"auto.ui.browser.metrics"}}))}function Eb(n,t,e,i,r,s){if(t.initiatorType==="xmlhttprequest"||t.initiatorType==="fetch")return;const o=Ii(e),a={[ye]:"auto.resource.browser.metrics"};Ra(a,t,"transferSize","http.response_transfer_size"),Ra(a,t,"encodedBodySize","http.response_content_length"),Ra(a,t,"decodedBodySize","http.decoded_response_content_length");const c=t.deliveryType;c!=null&&(a["http.response_delivery_type"]=c);const l=t.renderBlockingStatus;l&&(a["resource.render_blocking_status"]=l),o.protocol&&(a["url.scheme"]=o.protocol.split(":").pop()),o.host&&(a["server.address"]=o.host),a["url.same_origin"]=e.includes(Ft.location.origin);const{name:u,version:d}=Rf(t.nextHopProtocol);a["network.protocol.name"]=u,a["network.protocol.version"]=d;const h=s+i,p=h+r;Yn(n,h,p,{name:e.replace(Ft.location.origin,""),op:t.initiatorType?`resource.${t.initiatorType}`:"resource.other",attributes:a})}function yb(n){const t=Ft.navigator;if(!t)return;const e=t.connection;e&&(e.effectiveType&&n.setAttribute("effectiveConnectionType",e.effectiveType),e.type&&n.setAttribute("connectionType",e.type),wa(e.rtt)&&(Te["connection.rtt"]={value:e.rtt,unit:"millisecond"})),wa(t.deviceMemory)&&n.setAttribute("deviceMemory",`${t.deviceMemory} GB`),wa(t.hardwareConcurrency)&&n.setAttribute("hardwareConcurrency",String(t.hardwareConcurrency))}function Mb(n){ze&&(ze.element&&n.setAttribute("lcp.element",Ni(ze.element)),ze.id&&n.setAttribute("lcp.id",ze.id),ze.url&&n.setAttribute("lcp.url",ze.url.trim().slice(0,200)),ze.loadTime!=null&&n.setAttribute("lcp.loadTime",ze.loadTime),ze.renderTime!=null&&n.setAttribute("lcp.renderTime",ze.renderTime),n.setAttribute("lcp.size",ze.size)),hr!=null&&hr.sources&&hr.sources.forEach((t,e)=>n.setAttribute(`cls.source.${e+1}`,Ni(t.node)))}function Ra(n,t,e,i){const r=t[e];r!=null&&r<ab&&(n[i]=r)}function bb(n){const t=ps(!1);if(!t)return;const{responseStart:e,requestStart:i}=t;i<=e&&(n["ttfb.requestTime"]={value:e-i,unit:"millisecond"})}const Tb=1e3;let bd,zc,Hc;function Ab(n){const t="dom";di(t,n),hi(t,wb)}function wb(){if(!Ft.document)return;const n=rn.bind(null,"dom"),t=Td(n,!0);Ft.document.addEventListener("click",t,!1),Ft.document.addEventListener("keypress",t,!1),["EventTarget","Node"].forEach(e=>{var s,o;const r=(s=Ft[e])==null?void 0:s.prototype;(o=r==null?void 0:r.hasOwnProperty)!=null&&o.call(r,"addEventListener")&&($e(r,"addEventListener",function(a){return function(c,l,u){if(c==="click"||c=="keypress")try{const d=this.__sentry_instrumentation_handlers__=this.__sentry_instrumentation_handlers__||{},h=d[c]=d[c]||{refCount:0};if(!h.handler){const p=Td(n);h.handler=p,a.call(this,c,p,u)}h.refCount++}catch{}return a.call(this,c,l,u)}}),$e(r,"removeEventListener",function(a){return function(c,l,u){if(c==="click"||c=="keypress")try{const d=this.__sentry_instrumentation_handlers__||{},h=d[c];h&&(h.refCount--,h.refCount<=0&&(a.call(this,c,h.handler,u),h.handler=void 0,delete d[c]),Object.keys(d).length===0&&delete this.__sentry_instrumentation_handlers__)}catch{}return a.call(this,c,l,u)}}))})}function Rb(n){if(n.type!==zc)return!1;try{if(!n.target||n.target._sentryId!==Hc)return!1}catch{}return!0}function Cb(n,t){return n!=="keypress"?!1:t!=null&&t.tagName?!(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable):!0}function Td(n,t=!1){return e=>{if(!e||e._sentryCaptured)return;const i=Pb(e);if(Cb(e.type,i))return;Ye(e,"_sentryCaptured",!0),i&&!i._sentryId&&Ye(i,"_sentryId",nn());const r=e.type==="keypress"?"input":e.type;Rb(e)||(n({event:e,name:r,global:t}),zc=e.type,Hc=i?i._sentryId:void 0),clearTimeout(bd),bd=Ft.setTimeout(()=>{Hc=void 0,zc=void 0},Tb)}}function Pb(n){try{return n.target}catch{return null}}let Ks;function Tl(n){const t="history";di(t,n),hi(t,Ib)}function Ib(){if(Ft.addEventListener("popstate",()=>{const t=Ft.location.href,e=Ks;if(Ks=t,e===t)return;rn("history",{from:e,to:t})}),!Qy())return;function n(t){return function(...e){const i=e.length>2?e[2]:void 0;if(i){const r=Ks,s=String(i);if(Ks=s,r===s)return t.apply(this,e);rn("history",{from:r,to:s})}return t.apply(this,e)}}$e(Ft.history,"pushState",n),$e(Ft.history,"replaceState",n)}const ho={};function Db(n){const t=ho[n];if(t)return t;let e=Ft[n];if(Uc(e))return ho[n]=e.bind(Ft);const i=Ft.document;if(i&&typeof i.createElement=="function")try{const r=i.createElement("iframe");r.hidden=!0,i.head.appendChild(r);const s=r.contentWindow;s!=null&&s[n]&&(e=s[n]),i.head.removeChild(r)}catch(r){Ml&&it.warn(`Could not create sandbox iframe for ${n} check, bailing to window.${n}: `,r)}return e&&(ho[n]=e.bind(Ft))}function Ad(n){ho[n]=void 0}const fr="__sentry_xhr_v3__";function Cf(n){const t="xhr";di(t,n),hi(t,Lb)}function Lb(){if(!Ft.XMLHttpRequest)return;const n=XMLHttpRequest.prototype;n.open=new Proxy(n.open,{apply(t,e,i){const r=new Error,s=Fe()*1e3,o=Vn(i[0])?i[0].toUpperCase():void 0,a=Ub(i[1]);if(!o||!a)return t.apply(e,i);e[fr]={method:o,url:a,request_headers:{}},o==="POST"&&a.match(/sentry_key/)&&(e.__sentry_own_request__=!0);const c=()=>{const l=e[fr];if(l&&e.readyState===4){try{l.status_code=e.status}catch{}const u={endTimestamp:Fe()*1e3,startTimestamp:s,xhr:e,virtualError:r};rn("xhr",u)}};return"onreadystatechange"in e&&typeof e.onreadystatechange=="function"?e.onreadystatechange=new Proxy(e.onreadystatechange,{apply(l,u,d){return c(),l.apply(u,d)}}):e.addEventListener("readystatechange",c),e.setRequestHeader=new Proxy(e.setRequestHeader,{apply(l,u,d){const[h,p]=d,g=u[fr];return g&&Vn(h)&&Vn(p)&&(g.request_headers[h.toLowerCase()]=p),l.apply(u,d)}}),t.apply(e,i)}}),n.send=new Proxy(n.send,{apply(t,e,i){const r=e[fr];if(!r)return t.apply(e,i);i[0]!==void 0&&(r.body=i[0]);const s={startTimestamp:Fe()*1e3,xhr:e};return rn("xhr",s),t.apply(e,i)}})}function Ub(n){if(Vn(n))return n;try{return n.toString()}catch{}}const Ca=[],fo=new Map;function Nb(){if(bl()&&on()){const t=Fb();return()=>{t()}}return()=>{}}const wd={click:"click",pointerdown:"click",pointerup:"click",mousedown:"click",mouseup:"click",touchstart:"click",touchend:"click",mouseover:"hover",mouseout:"hover",mouseenter:"hover",mouseleave:"hover",pointerover:"hover",pointerout:"hover",pointerenter:"hover",pointerleave:"hover",dragstart:"drag",dragend:"drag",drag:"drag",dragenter:"drag",dragleave:"drag",dragover:"drag",drop:"drag",keydown:"press",keyup:"press",keypress:"press",input:"press"};function Fb(){return KM(({metric:n})=>{if(n.value==null)return;const t=n.entries.find(g=>g.duration===n.value&&wd[g.name]);if(!t)return;const{interactionId:e}=t,i=wd[t.name],r=pe(on()+t.startTime),s=pe(n.value),o=qe(),a=o?Oe(o):void 0,l=(e!=null?fo.get(e):void 0)||a,u=l?ne(l).description:ae().getScopeData().transactionName,d=Ni(t.target),h={[ye]:"auto.http.browser.inp",[Fi]:`ui.interaction.${i}`,[ds]:t.duration},p=wf({name:d,transaction:u,attributes:h,startTime:r});p&&(p.addEvent("inp",{[Do]:"millisecond",[Lo]:n.value}),p.end(r+s))})}function Ob(){const n=({entries:t})=>{const e=qe(),i=e&&Oe(e);t.forEach(r=>{if(!ib(r)||!i)return;const s=r.interactionId;if(s!=null&&!fo.has(s)){if(Ca.length>10){const o=Ca.shift();fo.delete(o)}Ca.push(s),fo.set(s,i)}})};rs("event",n),rs("first-input",n)}function Bb(n,t=Db("fetch")){let e=0,i=0;function r(s){const o=s.body.length;e+=o,i++;const a={body:s.body,method:"POST",referrerPolicy:"strict-origin",headers:n.headers,keepalive:e<=6e4&&i<15,...n.fetchOptions};if(!t)return Ad("fetch"),Eo("No fetch implementation available");try{return t(n.url,a).then(c=>(e-=o,i--,{statusCode:c.status,headers:{"x-sentry-rate-limits":c.headers.get("X-Sentry-Rate-Limits"),"retry-after":c.headers.get("Retry-After")}}))}catch(c){return Ad("fetch"),e-=o,i--,Eo(c)}}return fy(n,r)}const kb=30,zb=50;function Vc(n,t,e,i){const r={filename:n,function:t==="<anonymous>"?Oi:t,in_app:!0};return e!==void 0&&(r.lineno=e),i!==void 0&&(r.colno=i),r}const Hb=/^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,Vb=/^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,Gb=/\((\S*)(?::(\d+))(?::(\d+))\)/,Wb=n=>{const t=Hb.exec(n);if(t){const[,i,r,s]=t;return Vc(i,Oi,+r,+s)}const e=Vb.exec(n);if(e){if(e[2]&&e[2].indexOf("eval")===0){const o=Gb.exec(e[2]);o&&(e[2]=o[1],e[3]=o[2],e[4]=o[3])}const[r,s]=Pf(e[1]||Oi,e[2]);return Vc(s,r,e[3]?+e[3]:void 0,e[4]?+e[4]:void 0)}},Xb=[kb,Wb],$b=/^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,Yb=/(\S+) line (\d+)(?: > eval line \d+)* > eval/i,qb=n=>{const t=$b.exec(n);if(t){if(t[3]&&t[3].indexOf(" > eval")>-1){const s=Yb.exec(t[3]);s&&(t[1]=t[1]||"eval",t[3]=s[1],t[4]=s[2],t[5]="")}let i=t[3],r=t[1]||Oi;return[r,i]=Pf(r,i),Vc(i,r,t[4]?+t[4]:void 0,t[5]?+t[5]:void 0)}},jb=[zb,qb],Kb=[Xb,jb],Zb=Bh(...Kb),Pf=(n,t)=>{const e=n.indexOf("safari-extension")!==-1,i=n.indexOf("safari-web-extension")!==-1;return e||i?[n.indexOf("@")!==-1?n.split("@")[0]:Oi,e?`safari-extension:${t}`:`safari-web-extension:${t}`]:[n,t]},sn=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,Zs=1024,Jb="Breadcrumbs",Qb=(n={})=>{const t={console:!0,dom:!0,fetch:!0,history:!0,sentry:!0,xhr:!0,...n};return{name:Jb,setup(e){t.console&&Uy(iT(e)),t.dom&&Ab(nT(e,t.dom)),t.xhr&&Cf(rT(e)),t.fetch&&ff(sT(e)),t.history&&Tl(oT(e)),t.sentry&&e.on("beforeSendEvent",eT(e))}}},tT=Qb;function eT(n){return function(e){Qt()===n&&zi({category:`sentry.${e.type==="transaction"?"transaction":"event"}`,event_id:e.event_id,level:e.level,message:bi(e)},{event:e})}}function nT(n,t){return function(i){if(Qt()!==n)return;let r,s,o=typeof t=="object"?t.serializeAttribute:void 0,a=typeof t=="object"&&typeof t.maxStringLength=="number"?t.maxStringLength:void 0;a&&a>Zs&&(sn&&it.warn(`\`dom.maxStringLength\` cannot exceed ${Zs}, but a value of ${a} was configured. Sentry will use ${Zs} instead.`),a=Zs),typeof o=="string"&&(o=[o]);try{const l=i.event,u=aT(l)?l.target:l;r=Ni(u,{keyAttrs:o,maxStringLength:a}),s=xh(u)}catch{r="<unknown>"}if(r.length===0)return;const c={category:`ui.${i.name}`,message:r};s&&(c.data={"ui.component_name":s}),zi(c,{event:i.event,name:i.name,global:i.global})}}function iT(n){return function(e){if(Qt()!==n)return;const i={category:"console",data:{arguments:e.args,logger:"console"},level:Fy(e.level),message:Bu(e.args," ")};if(e.level==="assert")if(e.args[0]===!1)i.message=`Assertion failed: ${Bu(e.args.slice(1)," ")||"console.assert"}`,i.data.arguments=e.args.slice(1);else return;zi(i,{input:e.args,level:e.level})}}function rT(n){return function(e){if(Qt()!==n)return;const{startTimestamp:i,endTimestamp:r}=e,s=e.xhr[fr];if(!i||!r||!s)return;const{method:o,url:a,status_code:c,body:l}=s,u={method:o,url:a,status_code:c},d={xhr:e.xhr,input:l,startTimestamp:i,endTimestamp:r},h={category:"xhr",data:u,type:"http",level:df(c)};n.emit("beforeOutgoingRequestBreadcrumb",h,d),zi(h,d)}}function sT(n){return function(e){if(Qt()!==n)return;const{startTimestamp:i,endTimestamp:r}=e;if(r&&!(e.fetchData.url.match(/sentry_key/)&&e.fetchData.method==="POST"))if(e.fetchData.method,e.fetchData.url,e.error){const s=e.fetchData,o={data:e.error,input:e.args,startTimestamp:i,endTimestamp:r},a={category:"fetch",data:s,level:"error",type:"http"};n.emit("beforeOutgoingRequestBreadcrumb",a,o),zi(a,o)}else{const s=e.response,o={...e.fetchData,status_code:s==null?void 0:s.status};e.fetchData.request_body_size,e.fetchData.response_body_size,s==null||s.status;const a={input:e.args,response:s,startTimestamp:i,endTimestamp:r},c={category:"fetch",data:o,type:"http",level:df(o.status_code)};n.emit("beforeOutgoingRequestBreadcrumb",c,a),zi(c,a)}}}function oT(n){return function(e){if(Qt()!==n)return;let i=e.from,r=e.to;const s=Ii(Xt.location.href);let o=i?Ii(i):void 0;const a=Ii(r);o!=null&&o.path||(o=s),s.protocol===a.protocol&&s.host===a.host&&(r=a.relative),s.protocol===o.protocol&&s.host===o.host&&(i=o.relative),zi({category:"navigation",data:{from:i,to:r}})}}function aT(n){return!!n&&!!n.target}const cT=["EventTarget","Window","Node","ApplicationCache","AudioTrackList","BroadcastChannel","ChannelMergerNode","CryptoOperation","EventSource","FileReader","HTMLUnknownElement","IDBDatabase","IDBRequest","IDBTransaction","KeyOperation","MediaController","MessagePort","ModalWindow","Notification","SVGElementInstance","Screen","SharedWorker","TextTrack","TextTrackCue","TextTrackList","WebSocket","WebSocketWorker","Worker","XMLHttpRequest","XMLHttpRequestEventTarget","XMLHttpRequestUpload"],lT="BrowserApiErrors",uT=(n={})=>{const t={XMLHttpRequest:!0,eventTarget:!0,requestAnimationFrame:!0,setInterval:!0,setTimeout:!0,...n};return{name:lT,setupOnce(){t.setTimeout&&$e(Xt,"setTimeout",Rd),t.setInterval&&$e(Xt,"setInterval",Rd),t.requestAnimationFrame&&$e(Xt,"requestAnimationFrame",hT),t.XMLHttpRequest&&"XMLHttpRequest"in Xt&&$e(XMLHttpRequest.prototype,"send",fT);const e=t.eventTarget;e&&(Array.isArray(e)?e:cT).forEach(pT)}}},dT=uT;function Rd(n){return function(...t){const e=t[0];return t[0]=Ar(e,{mechanism:{data:{function:$n(n)},handled:!1,type:"instrument"}}),n.apply(this,t)}}function hT(n){return function(t){return n.apply(this,[Ar(t,{mechanism:{data:{function:"requestAnimationFrame",handler:$n(n)},handled:!1,type:"instrument"}})])}}function fT(n){return function(...t){const e=this;return["onload","onerror","onprogress","onreadystatechange"].forEach(r=>{r in e&&typeof e[r]=="function"&&$e(e,r,function(s){const o={mechanism:{data:{function:r,handler:$n(s)},handled:!1,type:"instrument"}},a=hl(s);return a&&(o.mechanism.data.handler=$n(a)),Ar(s,o)})}),n.apply(this,t)}}function pT(n){var i,r;const e=(i=Xt[n])==null?void 0:i.prototype;(r=e==null?void 0:e.hasOwnProperty)!=null&&r.call(e,"addEventListener")&&($e(e,"addEventListener",function(s){return function(o,a,c){try{mT(a)&&(a.handleEvent=Ar(a.handleEvent,{mechanism:{data:{function:"handleEvent",handler:$n(a),target:n},handled:!1,type:"instrument"}}))}catch{}return s.apply(this,[o,Ar(a,{mechanism:{data:{function:"addEventListener",handler:$n(a),target:n},handled:!1,type:"instrument"}}),c])}}),$e(e,"removeEventListener",function(s){return function(o,a,c){try{const l=a.__sentry_wrapped__;l&&s.call(this,o,l,c)}catch{}return s.call(this,o,a,c)}}))}function mT(n){return typeof n.handleEvent=="function"}const gT=()=>({name:"BrowserSession",setupOnce(){if(typeof Xt.document>"u"){sn&&it.warn("Using the `browserSessionIntegration` in non-browser environments is not supported.");return}ad({ignoreDuration:!0}),cd(),Tl(({from:n,to:t})=>{n!==void 0&&n!==t&&(ad({ignoreDuration:!0}),cd())})}}),_T="GlobalHandlers",vT=(n={})=>{const t={onerror:!0,onunhandledrejection:!0,...n};return{name:_T,setupOnce(){Error.stackTraceLimit=50},setup(e){t.onerror&&(xT(e),Cd("onerror")),t.onunhandledrejection&&(ET(e),Cd("onunhandledrejection"))}}},ST=vT;function xT(n){kh(t=>{const{stackParser:e,attachStacktrace:i}=If();if(Qt()!==n||mf())return;const{msg:r,url:s,line:o,column:a,error:c}=t,l=bT(yl(e,c||r,void 0,i,!1),s,o,a);l.level="error",Zh(l,{originalException:c,mechanism:{handled:!1,type:"onerror"}})})}function ET(n){zh(t=>{const{stackParser:e,attachStacktrace:i}=If();if(Qt()!==n||mf())return;const r=yT(t),s=ul(r)?MT(r):yl(e,r,void 0,i,!0);s.level="error",Zh(s,{originalException:r,mechanism:{handled:!1,type:"onunhandledrejection"}})})}function yT(n){if(ul(n))return n;try{if("reason"in n)return n.reason;if("detail"in n&&"reason"in n.detail)return n.detail.reason}catch{}return n}function MT(n){return{exception:{values:[{type:"UnhandledRejection",value:`Non-Error promise rejection captured with value: ${String(n)}`}]}}}function bT(n,t,e,i){const r=n.exception=n.exception||{},s=r.values=r.values||[],o=s[0]=s[0]||{},a=o.stacktrace=o.stacktrace||{},c=a.frames=a.frames||[],l=i,u=e,d=Vn(t)&&t.length>0?t:as();return c.length===0&&c.push({colno:l,filename:d,function:Oi,in_app:!0,lineno:u}),n}function Cd(n){sn&&it.log(`Global Handler attached: ${n}`)}function If(){const n=Qt();return(n==null?void 0:n.getOptions())||{stackParser:()=>[],attachStacktrace:!1}}const TT=()=>({name:"HttpContext",preprocessEvent(n){var o,a;if(!Xt.navigator&&!Xt.location&&!Xt.document)return;const t=((o=n.request)==null?void 0:o.url)||as(),{referrer:e}=Xt.document||{},{userAgent:i}=Xt.navigator||{},r={...(a=n.request)==null?void 0:a.headers,...e&&{Referer:e},...i&&{"User-Agent":i}},s={...n.request,...t&&{url:t},headers:r};n.request=s}}),AT="cause",wT=5,RT="LinkedErrors",CT=(n={})=>{const t=n.limit||wT,e=n.key||AT;return{name:RT,preprocessEvent(i,r,s){const o=s.getOptions();Ly(xl,o.stackParser,e,t,i,r)}}},PT=CT;function IT(n){return[Ty(),Ey(),dT(),tT(),ST(),PT(),ky(),TT(),gT()]}function DT(n={}){var e;return{...{defaultIntegrations:IT(),release:typeof __SENTRY_RELEASE__=="string"?__SENTRY_RELEASE__:(e=Xt.SENTRY_RELEASE)==null?void 0:e.id,sendClientReports:!0},...LT(n)}}function LT(n){const t={};for(const e of Object.getOwnPropertyNames(n)){const i=e;n[i]!==void 0&&(t[i]=n[i])}return t}function UT(){var c;const n=typeof Xt.window<"u"&&Xt;if(!n)return!1;const t=n.chrome?"chrome":"browser",e=n[t],i=(c=e==null?void 0:e.runtime)==null?void 0:c.id,r=as()||"",s=["chrome-extension:","moz-extension:","ms-browser-extension:","safari-web-extension:"],o=!!i&&Xt===Xt.top&&s.some(l=>r.startsWith(`${l}//`)),a=typeof n.nw<"u";return!!i&&!o&&!a}function NT(n={}){const t=DT(n);if(!t.skipBrowserExtensionCheck&&UT()){sn&&Gi(()=>{console.error("[Sentry] You cannot run Sentry this way in a browser extension, check: https://docs.sentry.io/platforms/javascript/best-practices/browser-extensions/")});return}sn&&!hf()&&it.warn("No Fetch API detected. The Sentry SDK requires a Fetch API compatible environment to send events. Please add a Fetch API polyfill.");const e={...t,stackParser:Bx(t.stackParser||Zb),integrations:YE(t),transport:t.transport||Bb};return ry(xM,e)}const Pd=new WeakMap,Pa=new Map,Df={traceFetch:!0,traceXHR:!0,enableHTTPTimings:!0,trackFetchStreamPerformance:!1};function FT(n,t){const{traceFetch:e,traceXHR:i,trackFetchStreamPerformance:r,shouldCreateSpanForRequest:s,enableHTTPTimings:o,tracePropagationTargets:a,onRequestSpanStart:c}={...Df,...t},l=typeof s=="function"?s:h=>!0,u=h=>kT(h,a),d={};e&&(n.addEventProcessor(h=>(h.type==="transaction"&&h.spans&&h.spans.forEach(p=>{if(p.op==="http.client"){const g=Pa.get(p.span_id);g&&(p.timestamp=g/1e3,Pa.delete(p.span_id))}}),h)),r&&eM(h=>{if(h.response){const p=Pd.get(h.response);p&&h.endTimestamp&&Pa.set(p,h.endTimestamp)}}),ff(h=>{const p=Yy(h,l,u,d);if(h.response&&h.fetchData.__span&&Pd.set(h.response,h.fetchData.__span),p){const g=Lf(h.fetchData.url),v=g?Ii(g).host:void 0;p.setAttributes({"http.url":g,"server.address":v}),o&&Id(p),c==null||c(p,{headers:h.headers})}})),i&&Cf(h=>{var g;const p=zT(h,l,u,d);if(p){o&&Id(p);let v;try{v=new Headers((g=h.xhr.__sentry_xhr_v3__)==null?void 0:g.request_headers)}catch{}c==null||c(p,{headers:v})}})}function OT(n){return n.entryType==="resource"&&"initiatorType"in n&&typeof n.nextHopProtocol=="string"&&(n.initiatorType==="fetch"||n.initiatorType==="xmlhttprequest")}function Id(n){const{url:t}=ne(n).data;if(!t||typeof t!="string")return;const e=rs("resource",({entries:i})=>{i.forEach(r=>{OT(r)&&r.name.endsWith(t)&&(BT(r).forEach(o=>n.setAttribute(...o)),setTimeout(e))})})}function gn(n=0){return((on()||performance.timeOrigin)+n)/1e3}function BT(n){const{name:t,version:e}=Rf(n.nextHopProtocol),i=[];return i.push(["network.protocol.version",e],["network.protocol.name",t]),on()?[...i,["http.request.redirect_start",gn(n.redirectStart)],["http.request.fetch_start",gn(n.fetchStart)],["http.request.domain_lookup_start",gn(n.domainLookupStart)],["http.request.domain_lookup_end",gn(n.domainLookupEnd)],["http.request.connect_start",gn(n.connectStart)],["http.request.secure_connection_start",gn(n.secureConnectionStart)],["http.request.connection_end",gn(n.connectEnd)],["http.request.request_start",gn(n.requestStart)],["http.request.response_start",gn(n.responseStart)],["http.request.response_end",gn(n.responseEnd)]]:i}function kT(n,t){const e=as();if(e){let i,r;try{i=new URL(n,e),r=new URL(e).origin}catch{return!1}const s=i.origin===r;return t?Ri(i.toString(),t)||s&&Ri(i.pathname,t):s}else{const i=!!n.match(/^\/(?!\/)/);return t?Ri(n,t):i}}function zT(n,t,e,i){const r=n.xhr,s=r==null?void 0:r[fr];if(!r||r.__sentry_own_request__||!s)return;const{url:o,method:a}=s,c=ai()&&t(o);if(n.endTimestamp&&c){const v=r.__sentry_xhr_span_id__;if(!v)return;const m=i[v];m&&s.status_code!==void 0&&(wh(m,s.status_code),m.end(),delete i[v]);return}const l=Lf(o),u=Ii(l||o),d=$y(o),h=!!qe(),p=c&&h?fs({name:`${a} ${d}`,attributes:{url:o,type:"xhr","http.method":a,"http.url":l,"server.address":u==null?void 0:u.host,[ye]:"auto.http.browser",[Fi]:"http.client",...(u==null?void 0:u.search)&&{"http.query":u==null?void 0:u.search},...(u==null?void 0:u.hash)&&{"http.fragment":u==null?void 0:u.hash}}}):new Bi;r.__sentry_xhr_span_id__=p.spanContext().spanId,i[r.__sentry_xhr_span_id__]=p,e(o)&&HT(r,ai()&&h?p:void 0);const g=Qt();return g&&g.emit("beforeOutgoingRequestSpan",p,n),p}function HT(n,t){const{"sentry-trace":e,baggage:i}=af({span:t});e&&VT(n,e,i)}function VT(n,t,e){var r;const i=(r=n.__sentry_xhr_v3__)==null?void 0:r.request_headers;if(!(i!=null&&i["sentry-trace"]))try{if(n.setRequestHeader("sentry-trace",t),e){const s=i==null?void 0:i.baggage;(!s||!GT(s))&&n.setRequestHeader("baggage",e)}}catch{}}function GT(n){return n.split(",").some(t=>t.trim().startsWith("sentry-"))}function Lf(n){try{return new URL(n,Xt.location.origin).href}catch{return}}function WT(){Xt.document?Xt.document.addEventListener("visibilitychange",()=>{const n=qe();if(!n)return;const t=Oe(n);if(Xt.document.hidden&&t){const e="cancelled",{op:i,status:r}=ne(t);sn&&it.log(`[Tracing] Transaction: ${e} -> since tab moved to the background, op: ${i}`),r||t.setStatus({code:Ee,message:e}),t.setAttribute("sentry.cancellation_reason","document.hidden"),t.end()}}):sn&&it.warn("[Tracing] Could not set up background tab detection due to lack of global document")}const XT=3600,Uf="sentry_previous_trace",$T="sentry.previous_trace";function YT(n,{linkPreviousTrace:t,consistentTraceSampling:e}){const i=t==="session-storage";let r=i?KT():void 0;n.on("spanStart",o=>{if(Oe(o)!==o)return;const a=ae().getPropagationContext();r=qT(r,o,a),i&&jT(r)});let s=!0;e&&n.on("beforeSampling",o=>{if(!r)return;const a=ae(),c=a.getPropagationContext();if(s&&c.parentSpanId){s=!1;return}a.setPropagationContext({...c,dsc:{...c.dsc,sample_rate:String(r.sampleRate),sampled:String(Gc(r.spanContext))},sampleRand:r.sampleRand}),o.parentSampled=Gc(r.spanContext),o.parentSampleRate=r.sampleRate,o.spanAttributes={...o.spanAttributes,[Th]:r.sampleRate}})}function qT(n,t,e){const i=ne(t);function r(){var a,c;try{return Number((a=e.dsc)==null?void 0:a.sample_rate)??Number((c=i.data)==null?void 0:c[pl])}catch{return 0}}const s={spanContext:t.spanContext(),startTimestamp:i.start_timestamp,sampleRate:r(),sampleRand:e.sampleRand};if(!n)return s;const o=n.spanContext;return o.traceId===i.trace_id?n:(Date.now()/1e3-n.startTimestamp<=XT&&(sn&&it.info(`Adding previous_trace ${o} link to span ${{op:i.op,...t.spanContext()}}`),t.addLink({context:o,attributes:{[xx]:"previous_trace"}}),t.setAttribute($T,`${o.traceId}-${o.spanId}-${Gc(o)?1:0}`)),s)}function jT(n){try{Xt.sessionStorage.setItem(Uf,JSON.stringify(n))}catch(t){sn&&it.warn("Could not store previous trace in sessionStorage",t)}}function KT(){var n;try{const t=(n=Xt.sessionStorage)==null?void 0:n.getItem(Uf);return JSON.parse(t)}catch{return}}function Gc(n){return n.traceFlags===1}const ZT="BrowserTracing",JT={...lo,instrumentNavigation:!0,instrumentPageLoad:!0,markBackgroundSpan:!0,enableLongTask:!0,enableLongAnimationFrame:!0,enableInp:!0,linkPreviousTrace:"in-memory",consistentTraceSampling:!1,_experiments:{},...Df};let Dd=!1;const QT=(n={})=>{Dd&&Gi(()=>{console.warn("Multiple browserTracingIntegration instances are not supported.")}),Dd=!0;const t=Xt.document;Vx();const{enableInp:e,enableLongTask:i,enableLongAnimationFrame:r,_experiments:{enableInteractions:s,enableStandaloneClsSpans:o},beforeStartSpan:a,idleTimeout:c,finalTimeout:l,childSpanTimeout:u,markBackgroundSpan:d,traceFetch:h,traceXHR:p,trackFetchStreamPerformance:g,shouldCreateSpanForRequest:v,enableHTTPTimings:m,instrumentPageLoad:f,instrumentNavigation:T,linkPreviousTrace:b,consistentTraceSampling:y,onRequestSpanStart:I}={...JT,...n},w=cb({recordClsStandaloneSpans:o||!1});e&&Nb(),r&&qt.PerformanceObserver&&PerformanceObserver.supportedEntryTypes&&PerformanceObserver.supportedEntryTypes.includes("long-animation-frame")?ub():i&&lb(),s&&db();const R={name:void 0,source:void 0};function U(E,x){const A=x.op==="pageload",N=a?a(x):x,O=N.attributes||{};x.name!==N.name&&(O[Bn]="custom",N.attributes=O),R.name=N.name,R.source=O[Bn];const W=Kh(N,{idleTimeout:c,finalTimeout:l,childSpanTimeout:u,disableAutoFinish:A,beforeSpanEnd:G=>{w(),gb(G,{recordClsOnPageloadSpan:!o}),Ud(E,void 0);const q=ae(),H=q.getPropagationContext();q.setPropagationContext({...H,traceId:W.spanContext().traceId,sampled:Xi(W),dsc:ci(G)})}});Ud(E,W);function X(){t&&["interactive","complete"].includes(t.readyState)&&E.emit("idleSpanEnableAutoFinish",W)}A&&t&&(t.addEventListener("readystatechange",()=>{X()}),X())}return{name:ZT,afterAllSetup(E){let x=as();function A(){const N=Fo(E);N&&!ne(N).timestamp&&(sn&&it.log(`[Tracing] Finishing current active span with op: ${ne(N).op}`),N.end())}if(E.on("startNavigationSpan",N=>{Qt()===E&&(A(),Wi().setPropagationContext({traceId:oi(),sampleRand:Math.random()}),ae().setPropagationContext({traceId:oi(),sampleRand:Math.random()}),U(E,{op:"navigation",...N}))}),E.on("startPageLoadSpan",(N,O={})=>{if(Qt()!==E)return;A();const W=O.sentryTrace||Ld("sentry-trace"),X=O.baggage||Ld("baggage"),G=Px(W,X);ae().setPropagationContext(G),U(E,{op:"pageload",...N})}),b!=="off"&&YT(E,{linkPreviousTrace:b,consistentTraceSampling:y}),Xt.location){if(f){const N=on();tA(E,{name:Xt.location.pathname,startTime:N?N/1e3:void 0,attributes:{[Bn]:"url",[ye]:"auto.pageload.browser"}})}T&&Tl(({to:N,from:O})=>{if(O===void 0&&(x==null?void 0:x.indexOf(N))!==-1){x=void 0;return}O!==N&&(x=void 0,eA(E,{name:Xt.location.pathname,attributes:{[Bn]:"url",[ye]:"auto.navigation.browser"}}))})}d&&WT(),s&&nA(E,c,l,u,R),e&&Ob(),FT(E,{traceFetch:h,traceXHR:p,trackFetchStreamPerformance:g,tracePropagationTargets:E.getOptions().tracePropagationTargets,shouldCreateSpanForRequest:v,enableHTTPTimings:m,onRequestSpanStart:I})}}};function tA(n,t,e){return n.emit("startPageLoadSpan",t,e),ae().setTransactionName(t.name),Fo(n)}function eA(n,t){return n.emit("startNavigationSpan",t),ae().setTransactionName(t.name),Fo(n)}function Ld(n){const t=Xt.document,e=t==null?void 0:t.querySelector(`meta[name=${n}]`);return(e==null?void 0:e.getAttribute("content"))||void 0}function nA(n,t,e,i,r){const s=Xt.document;let o;const a=()=>{const c="ui.action.click",l=Fo(n);if(l){const u=ne(l).op;if(["navigation","pageload"].includes(u)){sn&&it.warn(`[Tracing] Did not create ${c} span because a pageload or navigation span is in progress.`);return}}if(o&&(o.setAttribute(Tc,"interactionInterrupted"),o.end(),o=void 0),!r.name){sn&&it.warn(`[Tracing] Did not create ${c} transaction because _latestRouteName is missing.`);return}o=Kh({name:r.name,op:c,attributes:{[Bn]:r.source||"url"}},{idleTimeout:t,finalTimeout:e,childSpanTimeout:i})};s&&addEventListener("click",a,{once:!1,capture:!0})}const Nf="_sentry_idleSpan";function Fo(n){return n[Nf]}function Ud(n,t){Ye(n,Nf,t)}NT({dsn:"https://a3cba31734e8caf17b0ff0dfa7fe95ee@o4509310067539968.ingest.de.sentry.io/4509310074683472",integrations:[QT()],tracesSampleRate:1,sendDefaultPii:!0});let Ce,_n,vn,be,Sn={left:0,right:0},Hr,Nd=!0,Ia=!1,Da=!1;const cr={};function iA(){const n=document.querySelector("#c"),t=new gS({antialias:!0,canvas:n});t.setSize(window.innerWidth,window.innerHeight);const e=new vm;e.background=new Bt(2105376);const i=new tn(75,window.innerWidth/window.innerHeight,.1,100);i.position.set(0,10,30);const r=new vS(i,t.domElement);r.enablePan=!1,r.enableZoom=!0,r.target.set(0,5,0),r.update();const s=new Pm(16777215,.3);e.add(s);const o=new Cm(16777215,1);o.position.set(-20,2.8,10),e.add(o);const a=new Am,c=a.load("textures/bois/wood_table_001_diff_4k.webp"),l=a.load("textures/bois/wood_table_001_nor_gl_4k.webp"),u=a.load("textures/bois/wood_table_001_rough_4k.webp"),d=new Ui(20,.5,40),h=new aa({map:c,normalMap:l,roughnessMap:u,roughness:1}),p=new He(d,h);p.position.y=-.25,e.add(p);const g=new Ui(4,1,1),v=new aa({color:14705250}),m=new aa({color:6268131});_n=new He(g,v),vn=new He(g,m),_n.position.set(0,.5,-18),vn.position.set(0,.5,18),e.add(_n),e.add(vn);const f=new nl(.7,64,64),T=new Ue({uniforms:{time:{value:0}},vertexShader:`
    ...
    `});Ce=new He(f,T),Ce.position.set(0,.7,0),e.add(Ce),be=new F(.4,0,.2),Hr=new XS(t),Hr.addPass(new $S(e,i));const b=new yr(new yt(window.innerWidth,window.innerHeight),.4,.4,.85);Hr.addPass(b),requestIdleCallback(()=>{const A=new al,N=A.addFolder("Game Controls");N.add(be,"x",-.2,.4).name("Vélocité X"),N.add(be,"z",-.2,.4).name("Vélocité Z"),N.open();const O=A.addFolder("Lumière");O.add(o.position,"x",-20,20).name("X"),O.add(o.position,"y",2.8,50).name("Y"),O.open();const W={resetScore(){Sn.left=0,Sn.right=0,I()},resetBall(){U()}};A.add(W,"resetScore").name("Reset Score"),A.add(W,"resetBall").name("Reset Ball");const X={dynamicCamera:!0};A.add(X,"dynamicCamera").name("Caméra dynamique").onChange(q=>{Nd=q});const G={restartGame(){Sn.left=0,Sn.right=0,I(),Da=!1,U(),document.getElementById("winOverlay").style.opacity=0,E()}};A.add(G,"restartGame").name("Nouvelle manche")});const y=document.createElement("div");y.style.position="absolute",y.style.top="10px",y.style.left="50%",y.style.transform="translateX(-50%)",y.style.color="white",y.style.fontSize="24px",y.style.fontFamily="monospace",y.id="scoreBoard",document.body.appendChild(y);function I(){document.getElementById("scoreBoard").innerHTML=`
      <span style="color:#5fa4e3;">Blue: ${Sn.right}</span> |
      <span style="color:#e06262;">Red: ${Sn.left}</span> 
    `}window.addEventListener("keydown",A=>cr[A.code]=!0),window.addEventListener("keyup",A=>cr[A.code]=!1);function w(A){if(Nd){const W=A*1e-4*.2;i.position.x=Math.cos(W)*30,i.position.z=Math.sin(W)*30,i.position.y=12+Math.sin(W*2)*2,i.lookAt(0,0,0)}if(requestAnimationFrame(w),!Ia||Da){Hr.render();return}R(A),Hr.render()}function R(A){Ce.material.uniforms&&(Ce.material.uniforms.time.value=A*.001),cr.ArrowLeft&&(vn.position.x-=.5),cr.ArrowRight&&(vn.position.x+=.5),cr.KeyA&&(_n.position.x-=.5),cr.KeyD&&(_n.position.x+=.5);const N=-8,O=8;_n.position.x=Sc.clamp(_n.position.x,N,O),vn.position.x=Sc.clamp(vn.position.x,N,O),Ce.position.add(be),(Ce.position.x<=-10||Ce.position.x>=10)&&(be.x*=-1);const W=new ri().setFromObject(Ce),X=new ri().setFromObject(_n),G=new ri().setFromObject(vn),q=1.05,H=2.5;if(W.intersectsBox(X)){const et=Ce.position.x-_n.position.x;be.x=et*.15,be.z=Math.abs(be.z),be.multiplyScalar(q),be.clampLength(0,H),Ce.position.z=_n.position.z+1.1}if(W.intersectsBox(G)){const et=Ce.position.x-vn.position.x;be.x=et*.15,be.z=-Math.abs(be.z),be.multiplyScalar(q),be.clampLength(0,H),Ce.position.z=vn.position.z-1.1}if(Ce.position.z<-18&&(Sn.right++,I(),U()),Ce.position.z>18&&(Sn.left++,I(),U()),Sn.right>=10){x("BLUE");return}if(Sn.left>=10){x("RED");return}}function U(){Ce.position.set(0,.7,0),be.set(Math.random()-.5,0,(Math.random()<.5?1:-1)*be.x)}function E(){const A=document.getElementById("introOverlay");A.textContent="READY...",A.style.opacity=1,Ia=!1,setTimeout(()=>{A.textContent="GO!"},1500),setTimeout(()=>{A.style.opacity=0,Ia=!0},3e3)}function x(A){const N=document.getElementById("winOverlay");A==="BLUE"?N.style.color="#5fa4e3":A==="RED"&&(N.style.color="#e06262"),N.textContent=`${A} WINS!`,N.style.opacity=1,Da=!0}I(),w(),E()}iA();
